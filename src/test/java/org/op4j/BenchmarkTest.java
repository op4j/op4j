...
public class BenchmarkTest {
	...
	public void test() {
		...
		try {
			...
			Level0ListOperator<User,List<User>> op1 = null;
			op4jWatch.start();
			for (int i = 0; i < ITERATIONS; i++) {
				op1 = Op.onList(users);
			}
			...
			Level1ListElementsOperator<User,List<User>> op2 = null;
			op4jWatch.start();
			for (int i = 0; i < ITERATIONS; i++) {
				op2 = op1.forEach();
			}
			...
			Level1ListElementsOperator<String,List<User>> op3 = null;
			op4jWatch.start();
			for (int i = 0; i < ITERATIONS; i++) {
			...
			Level1ListElementsOperator<String,List<User>> op4 = null;
			op4jWatch.start();
			for (int i = 0; i < ITERATIONS; i++) {
			...
			Level0ListOperator<String,List<User>> op5 = null;
			op4jWatch.start();
			for (int i = 0; i < ITERATIONS; i++) {
				op5 = op4.endFor();
			}
			...
			Level0ArrayOperator<String,List<User>> op6 = null;
			op4jWatch.start();
			for (int i = 0; i < ITERATIONS; i++) {
