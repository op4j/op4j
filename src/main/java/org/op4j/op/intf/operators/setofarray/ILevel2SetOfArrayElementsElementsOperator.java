...
public interface ILevel2SetOfArrayElementsElementsOperator<T> 
    ...
    public <X> ILevel2SetOfArrayElementsElementsOperator<X> exec(final IExec<X,? super T> exec);
    
    public <X> ILevel2SetOfArrayElementsElementsOperator<X> of(final IOf<X> of);
