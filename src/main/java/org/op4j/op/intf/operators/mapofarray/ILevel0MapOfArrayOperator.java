...
import org.op4j.op.intf.qualities.IConvertibleToMapOfListOperator;
import org.op4j.op.intf.qualities.IConvertibleToMapOfMapOperator;
import org.op4j.op.intf.qualities.IConvertibleToMapOfSetOperator;
...
public interface ILevel0MapOfArrayOperator<K,V>
    ...
    public <X,Y> ILevel0MapOfArrayOperator<X,Y> of(final IOf<X> ofX, final IOf<Y> ofY);
    ...
    public ILevel0MapOfArrayOperator<K,V> removeAll(final K... keys);
    ...
    public ILevel0MapOfArrayOperator<K,V> removeAllBut(final K... keys);
    public ILevel0MapOfArrayOperator<K,V> removeAllBut(final String expression, final Object... optionalExpParams);
    public ILevel0MapOfArrayOperator<K,V> removeAllBut(final ISelect<Map.Entry<K,V[]>> selector);
    ...
    public ILevel1MapOfArrayEntriesOperator<K,V> forEachEntryNot(final ISelect<Map.Entry<K,V[]>> selector);
