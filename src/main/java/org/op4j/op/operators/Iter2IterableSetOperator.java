 ...
 *
 */
public final class Iter2IterableSetOperator<T> 
        extends Iter2AbstractOperator<Set<T>>
    ...
    Iter2IterableSetOperator(
            final Type operatorComponentType, final List<Iter1IterableSetOperator<T>> iterationComponents) {
        super(iterationComponents);
        this.operatorComponentType = operatorComponentType;
    }
    
    
    Iter2IterableSetOperator(final Class<T> operatorComponentClass, final List<Iter1IterableSetOperator<T>> iterationComponents) {
    ...
    final List<Iter1IterableSetOperator<T>> getTargets() {
        return (List<Iter1IterableSetOperator<T>>) getAbstractTargets();
    }
    ...
    @SuppressWarnings("unchecked")
    final Iter2IterableSetOperator<?> unsafeRaw() {
        final List<Iter1IterableSetOperator<?>> components = 
            new ArrayList<Iter1IterableSetOperator<?>>();
        for (Iter1IterableSetOperator<T> targetOp : this.getTargets()) {
            components.add(targetOp.unsafeRaw());
        }
        return new Iter2IterableSetOperator((Type) null, components);
    }
    
    
    public final Iter2IterableSetOperator<?> raw() {
        return unsafeRaw();
    }
    

    final <X> Iter2IterableSetOperator<X> unsafeEachExecUniq(
        ...
        for (Iter1IterableSetOperator<T> target : getTargets()) {
            components.add(target.unsafeEachExecUniq(resultClass, operationName, parameters));
        }
        return new Iter2IterableSetOperator<X>(resultClass, components);
    }
    

    public final Iter2IterableSetOperator<?> eachExecUniq(
    ...
    public final <X> Iter2IterableSetOperator<X> eachExecUniq(
    ...
    @SuppressWarnings("unchecked")
    final Iter2GenericUniqTargetOperator<Set<T>> unsafeGeneric() {
        final List<Iter1GenericUniqTargetOperator<Set<T>>> components = 
            new ArrayList<Iter1GenericUniqTargetOperator<Set<T>>>();
        for (Iter1IterableSetOperator<T> targetOp : this.getTargets()) {
            components.add(targetOp.unsafeGeneric());
        }
        return new Iter2GenericUniqTargetOperator(TypeAggregationUtils.createSetOfType(getOperatorComponentType()), components);
    }
    
    
    public final Iter2GenericUniqTargetOperator<Set<T>> generic() {
    ...
    final Iter2GenericMultiTargetOperator<T> unsafeFlat() {
        ...
        for (Iter1IterableSetOperator<T> target : this.getTargets()) {
    ...
    final Iter2IterableSetOperator<T> unsafeSort() {
        return unsafeSort(null);
    }


    public final Iter2IterableSetOperator<T> sort() {
        return unsafeSort();
    }


    final Iter2IterableSetOperator<T> unsafeSort(final Comparator<? super T> comparator) {
    ...
    public final Iter2IterableSetOperator<T> sort(final Comparator<? super T> comparator) {
    ...
    public final Iter1IterableArrayOperator<Set<T>> uneachArray() {
        return unsafeGeneric().unsafeUneachArray();
    }


    public final Iter1IterableListOperator<Set<T>> uneachList() {
        return unsafeGeneric().unsafeUneachList();
    }


    public final Iter1IterableSetOperator<Set<T>> uneachSet() {
        return unsafeGeneric().unsafeUneachSet();
    }
    
    
    public final Iter1IterableMapOperator<?,Set<T>> uneachMap(
    ...
    public final <K> Iter1IterableMapOperator<K,Set<T>> uneachMap(
    ...
    public final Iter1IterableListMapOperator<?,Set<T>> uneachListMap(
            final String keyExpression, final Object... optionalExpParams) {
        Validate.notNull(keyExpression, "Key expression cannot be null");
    ...
    public final <K> Iter1IterableListMapOperator<K,Set<T>> uneachListMap(
            final Class<K> keyClass, final String keyExpression, final Object... optionalExpParams) {
        Validate.notNull(keyClass, "Key class cannot be null");
        Validate.notNull(keyExpression, "Key expression cannot be null");
    ...
    public final Iter1IterableSetMapOperator<?,Set<T>> uneachSetMap(
            final String keyExpression, final Object... optionalExpParams) {
        Validate.notNull(keyExpression, "Key expression cannot be null");
    ...
    public final <K> Iter1IterableSetMapOperator<K,Set<T>> uneachSetMap(
            final Class<K> keyClass, final String keyExpression, final Object... optionalExpParams) {
        Validate.notNull(keyClass, "Key class cannot be null");
        Validate.notNull(keyExpression, "Key expression cannot be null");
    ...
    final Iter2IterableSetOperator<T> unsafeEachFilter(
    ...
    final Iter2IterableSetOperator<T> unsafeEachFilter(final Filter<T> filter) {
        final List<Iter1IterableSetOperator<T>> components = 
            new ArrayList<Iter1IterableSetOperator<T>>();
        for (Iter1IterableSetOperator<T> target : this.getTargets()) {
    ...
    public final Iter2IterableSetOperator<T> eachFilter(
    ...
    public final Iter2IterableSetOperator<T> eachFilter(final Filter<T> filter) {
    ...
    final <X> Iter2IterableSetOperator<X> unsafeEachEval(
    ...
    public final Iter2IterableSetOperator<?> eachEval(final String expression, final Object... optionalExpParams) {
    ...
    public final <X> Iter2IterableSetOperator<X> eachEval(
    ...
    public final Iter2IterableSetOperator<?> eachEval(
    ...
    final <X> Iter2IterableSetOperator<X> unsafeEachCall(
    ...
    public final Iter2IterableSetOperator<?> eachCall(
    ...
    public final <X> Iter2IterableSetOperator<X> eachCall(
    ...
    final <X> Iter2IterableSetOperator<X> unsafeEachTo(
    ...
    public final Iter2IterableSetOperator<?> eachTo(
    ...
    public final <X> Iter2IterableSetOperator<X> eachTo(
