...
public final class Iter1IterableSetMapOperator<K,V> 
    ...
    final <X> Iter1IterableSetMapOperator<K,X> unsafeEachExecUniqValue(
    ...
    public final Iter1IterableSetMapOperator<K,?> eachExecUniqValue(
    ...
    public final <X> Iter1IterableSetMapOperator<K,X> eachExecUniqValue(
    ...
    final <X> Iter1IterableSetMapOperator<K,X> unsafeEachEvalValue(
            final Class<X> resultClass, final String expression, final List<Object> parameters) {
        final List<Iter0IterableSetMapOperator<K,X>> components = 
            new ArrayList<Iter0IterableSetMapOperator<K,X>>();
        for (Iter0IterableSetMapOperator<K,V> targetOp : this.getTargets()) {
    ...
    public final Iter1IterableSetMapOperator<K,?> eachEvalValue(final String expression, final Object... optionalExpParams) {
    ...
    public final <X> Iter1IterableSetMapOperator<K,X> eachEvalValue(
    ...
    public final Iter1IterableSetMapOperator<K,?> eachEvalValue(
    ...
    final <X> Iter1IterableSetMapOperator<K,X> unsafeEachCallValue(
    ...
    public final Iter1IterableSetMapOperator<K,?> eachCallValue(
    ...
    public final <X> Iter1IterableSetMapOperator<K,X> eachCallValue(
    ...
    final <X> Iter1IterableSetMapOperator<K,X> unsafeEachToValue(
    ...
    public final Iter1IterableSetMapOperator<K,?> eachToValue(
    ...
    public final <X> Iter1IterableSetMapOperator<K,X> eachToValue(
