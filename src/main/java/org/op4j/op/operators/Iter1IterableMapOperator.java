...
public final class Iter1IterableMapOperator<K,V> 
    ...
    final <X> Iter1IterableMapOperator<K,X> unsafeEachValueExec(
    ...
    public final Iter1IterableMapOperator<K,?> eachValueExec(
    ...
    public final <X> Iter1IterableMapOperator<K,X> eachValueExec(
    ...
    final <X> Iter1IterableMapOperator<K,X> unsafeEachValueEval(
    ...
    public final Iter1IterableMapOperator<K,?> eachValueEval(final String expression, final Object... optionalExpParams) {
    ...
    public final <X> Iter1IterableMapOperator<K,X> eachValueEval(
    ...
    public final Iter1IterableMapOperator<K,?> eachValueEval(
    ...
    final <X> Iter1IterableMapOperator<K,X> unsafeEachValueCall(
    ...
    public final Iter1IterableMapOperator<K,?> eachValueCall(
    ...
    public final <X> Iter1IterableMapOperator<K,X> eachValueCall(
    ...
    final <X> Iter1IterableMapOperator<K,X> unsafeEachValueTo(
    ...
    public final Iter1IterableMapOperator<K,?> eachValueTo(
    ...
    public final <X> Iter1IterableMapOperator<K,X> eachValueTo(
