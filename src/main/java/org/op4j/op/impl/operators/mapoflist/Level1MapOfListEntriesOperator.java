...
import org.op4j.op.intf.operators.mapoflist.ILevel1MapOfListEntriesOperator;
import org.op4j.op.intf.operators.mapoflist.ILevel2MapOfListEntriesKeyOperator;
...
public class Level1MapOfListEntriesOperator<K,V> extends Operator
    ...
    public <X, Y> ILevel1MapOfListEntriesOperator<X, Y> of(IOf<X> ofX,
            IOf<Y> ofY) {
