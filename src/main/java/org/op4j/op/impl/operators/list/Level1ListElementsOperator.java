 ...
 * =============================================================================
 */
package org.op4j.op.impl.operators.list;
...
import org.op4j.op.intf.operators.list.ILevel1ListElementsOperator;
...
public class Level1ListElementsOperator<T> extends Operator
    ...
    public <X> ILevel1ListElementsOperator<X> of(IOf<X> of) {
        // TODO Auto-generated method stub
        return null;
    }
