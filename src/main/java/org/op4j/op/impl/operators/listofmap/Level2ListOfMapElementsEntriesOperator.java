 ...
 * =============================================================================
 */
package org.op4j.op.impl.operators.listofmap;
...
import org.op4j.op.intf.operators.listofmap.ILevel2ListOfMapElementsEntriesOperator;
import org.op4j.op.intf.operators.listofmap.ILevel3ListOfMapElementsEntriesKeyOperator;
import org.op4j.op.intf.operators.listofmap.ILevel3ListOfMapElementsEntriesValueOperator;
...
public class Level2ListOfMapElementsEntriesOperator<K,V> extends Operator
    ...
    public <X, Y> ILevel2ListOfMapElementsEntriesOperator<X, Y> of(IOf<X> ofX,
            IOf<Y> ofY) {
