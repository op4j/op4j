...
public interface ExecutableSetOfArraySelectedOperator<T> {
     ...
     */
    public ExecutableSetOfArraySelectedOperator<T> execIfNotNullAsSetOfArray(final IFunction<? extends Set<? extends T[]>,? super Set<T[]>> function);
     ...
     */
    public ExecutableSetOfArraySelectedOperator<T> mapMap(final IFunction<? extends T,? super T> function);
