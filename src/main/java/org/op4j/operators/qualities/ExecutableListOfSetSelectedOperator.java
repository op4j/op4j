...
public interface ExecutableListOfSetSelectedOperator<T> {
     ...
     */
    public ExecutableListOfSetSelectedOperator<T> execAsListOfSet(final IFunction<? extends List<? extends Set<? extends T>>, ? super List<Set<T>>> function);
    
    
    /**
     * <p>
     * Executes a function in a way equivalent to {@link #execAsListOfSet(IFunction)} but only
     ...
     */
    public ExecutableListOfSetSelectedOperator<T> mapMap(final IFunction<? extends T,? super T> function);
