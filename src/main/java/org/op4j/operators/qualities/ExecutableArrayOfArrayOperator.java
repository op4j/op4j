...
public interface ExecutableArrayOfArrayOperator<T> {
    ...
    /**
     * <p>
     * Executes a function in a way equivalent to {@link #execAsArrayOfArray(IFunction)} but only
     ...
     * @return an operator on the results of function execution
     */
    public ExecutableArrayOfArrayOperator<T> execIfNotNullAsArrayOfArray(final IFunction<? extends T[][],? super T[][]> function);
    ...
    /**
     * <p>
     * Executes a function in a way equivalent to {@link #execAsArrayOfArrayOf(Type, IFunction)} but only
     * on non-null elements, leaving null elements untouched.
     * </p>
     * 
     * @param <X> the type of the result elements
     ...
     * @return an operator on the results of function execution
     */
    public <X> ExecutableArrayOfArrayOperator<X> execIfNotNullAsArrayOfArrayOf(final Type<X> type, final IFunction<X[][],? super T[][]> function);
