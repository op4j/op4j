...
public interface ExecutableMapOfArrayOperator<K,V> {
     ...
     */
    public <X,Y> ExecutableMapOfArrayOperator<X,Y> execAsMapOfArray(final IFunction<? extends Map<X,Y[]>, ? super Map<K,V[]>> function);
     ...
     */
    public <X,Y> ExecutableMapOfArrayOperator<X,Y> evalAsMapOfArray(final IEvaluator<? extends Map<X,Y[]>,? super Map<K,V[]>> eval);
     ...
     */
    public <X,Y> ExecutableMapOfArrayOperator<X,Y> convertAsMapOfArray(final IConverter<? extends Map<X,Y[]>,? super Map<K,V[]>> converter);
