...
public interface ExecutableSetOfSetOperator<T> {
    ...
    /**
     * <p>
     * Executes a function in a way equivalent to {@link #execAsSetOfSet(IFunction)} but only
     ...
     * @return an operator on the results of function execution
     */
    public <X> ExecutableSetOfSetOperator<X> execIfNotNullAsSetOfSet(final IFunction<? extends Set<? extends Set<X>>,? super Set<Set<T>>> function);
     ...
     */
    public <X> ExecutableSetOfSetOperator<X> mapMap(final IFunction<X,? super T> function);
