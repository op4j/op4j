...
public interface ExecutableArrayOfSetSelectedOperator<T> {
    ...
    /**
     * <p>
     * Executes a function in a way equivalent to {@link #execAsArrayOfSet(IFunction)} but only
     ...
     * @return an operator on the results of function execution
     */
    public ExecutableArrayOfSetSelectedOperator<T> execIfNotNullAsArrayOfSet(final IFunction<? extends Set<? extends T>[],? super Set<T>[]> function);
