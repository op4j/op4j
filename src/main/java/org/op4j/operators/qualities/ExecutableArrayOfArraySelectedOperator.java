 ...
 * array of array target objects on which a selection ("if") has already been done.
 * </p>
 * 
 * @since 1.0
 * 
 ...
 *
 */
public interface ExecutableArrayOfArraySelectedOperator<T> {
     ...
     */
    public ExecutableArrayOfArraySelectedOperator<T> mapMap(final IFunction<? extends T,? super T> function);
