 ...
 *
 */
public interface ExecutableSetOfArrayOperator<T,I> {

    public <X> ExecutableSetOfArrayOperator<X,I> exec(final IFunction<? extends Set<X[]>, ? super Set<T[]>> function);
    
    public <X> ExecutableSetOfArrayOperator<X,I> eval(final IEvaluator<? extends Set<X[]>,? super Set<T[]>> eval);
    
    public <X> ExecutableSetOfArrayOperator<X,I> convert(final IConverter<? extends Set<X[]>,? super Set<T[]>> converter);
