...
public interface ExecutableArrayOfListOperator<T> {
     ...
     */
    public <X> ExecutableArrayOfListOperator<X> execAsArrayOfList(final IFunction<? extends List<X>[], ? super List<T>[]> function);
     ...
     */
    public <X> ExecutableArrayOfListOperator<X> mapMap(final IFunction<X,? super T> function);
