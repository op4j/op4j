...
public final class Level0MapSelectedOperatorImpl<K,V,I> extends AbstractOperatorImpl implements Level0MapSelectedOperator<K,V,I> {
    ...
    public Level0MapSelectedOperator<K,V,I> removeAllTrue(final IFunction<Boolean,? super Entry<K,V>> eval) {
        return new Level0MapSelectedOperatorImpl<K,V,I>(getTarget().execute(new FMap.RemoveAllTrue<K,V>(eval)));
    }


    public Level0MapSelectedOperator<K,V,I> removeAllFalse(final IFunction<Boolean,? super Entry<K,V>> eval) {
