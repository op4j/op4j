...
public final class Level0ArrayOperatorImpl<T,I> 
    ...
    public <X> Level0ArrayOperator<X,I> execAsArrayOf(final Type<X> newType, final IFunction<X[], ? super T[]> function) {
    ...
    public <X> Level0ArrayOperator<X,I> map(final Type<X> newType, final IFunction<X, ? super T> function) {
