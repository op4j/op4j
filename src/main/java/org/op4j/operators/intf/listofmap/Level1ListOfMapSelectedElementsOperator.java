...
public interface Level1ListOfMapSelectedElementsOperator<K,V>
    ...
    public Level1ListOfMapSelectedElementsOperator<K,V> removeMatching(final IEvaluator<Boolean, ? super Map.Entry<K,V>> eval);
    public Level1ListOfMapSelectedElementsOperator<K,V> removeNotMatching(final IEvaluator<Boolean, ? super Map.Entry<K,V>> eval);
