...
public interface Level2ListOfMapElementsEntriesOperator<K,V> 
    ...
    public Level2ListOfMapElementsEntriesSelectedOperator<K,V> ifTrue(final IFunction<Boolean, ? super Map.Entry<K, V>> eval);
    public Level2ListOfMapElementsEntriesSelectedOperator<K,V> ifFalse(final IFunction<Boolean, ? super Map.Entry<K, V>> eval);
    ...
    public <X,Y> Level2ListOfMapElementsEntriesOperator<X,Y> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<X,Y>,? super Map.Entry<K,V>> function);
    ...
    public <X> Level2ListOfListElementsElementsOperator<X> execIfNotNull(final IFunction<X,? super Map.Entry<K,V>> function);
