...
public interface Level1ListOfMapSelectedElementsSelectedOperator<K,V>
    ...
    public Level1ListOfMapSelectedElementsSelectedOperator<K,V> removeAllTrue(final IFunction<Boolean, ? super Map.Entry<K,V>> eval);
    public Level1ListOfMapSelectedElementsSelectedOperator<K,V> removeAllFalse(final IFunction<Boolean, ? super Map.Entry<K,V>> eval);
