...
public interface ILevel1ListOfMapElementsOperator<K,V> 
    ...
    public ILevel1ListOfMapElementsOperator<K,V> removeMatching(final IEval<Boolean, ? super Map.Entry<K,V>> eval);
    public ILevel1ListOfMapElementsOperator<K,V> removeSelected(final ISelect<Map.Entry<K,V>> selector);
