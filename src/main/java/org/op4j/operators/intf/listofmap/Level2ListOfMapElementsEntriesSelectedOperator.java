...
public interface Level2ListOfMapElementsEntriesSelectedOperator<K,V> 
    ...
    public Level2ListOfMapElementsEntriesSelectedOperator<K,V> exec(final IFunction<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> function);
    
    public Level2ListOfMapElementsEntriesSelectedOperator<K,V> eval(final IEvaluator<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> eval);
    
    public Level2ListOfMapElementsEntriesSelectedOperator<K,V> convert(final IConverter<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> converter);
