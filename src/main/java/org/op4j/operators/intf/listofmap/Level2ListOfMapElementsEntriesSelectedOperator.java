...
public interface Level2ListOfMapElementsEntriesSelectedOperator<K,V> 
    ...
    public Level2ListOfMapElementsEntriesSelectedOperator<K,V> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> function);
