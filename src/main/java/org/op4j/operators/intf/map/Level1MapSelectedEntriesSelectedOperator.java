...
public interface Level1MapSelectedEntriesSelectedOperator<K,V>
    ...
    public Level1MapSelectedEntriesSelectedOperator<K,V> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> function);
