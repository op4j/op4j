 ...
 *
 */
public interface ILevel2MapEntriesKeyOperator<K,V>
    ...
    public <X> ILevel2MapEntriesKeyOperator<X,V> of(final IOf<X> of);
    
    public <X> ILevel2MapEntriesKeyOperator<X,V> of(final Class<X> classOf);
