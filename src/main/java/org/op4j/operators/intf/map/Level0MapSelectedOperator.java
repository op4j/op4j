...
public interface Level0MapSelectedOperator<K,V>
    ...
    public Level0MapSelectedOperator<K,V> removeAllTrue(final IFunction<Boolean, ? super Map.Entry<K,V>> eval);
    public Level0MapSelectedOperator<K,V> removeAllFalse(final IFunction<Boolean, ? super Map.Entry<K,V>> eval);
