...
public interface ILevel2MapSelectedEntriesSelectedKeyOperator<I,K,V>
    ...
    public ILevel2MapSelectedEntriesSelectedKeySelectedOperator<I,K,V> ifIndex(final int... indexes);
    ...
    public ILevel2MapSelectedEntriesSelectedKeySelectedOperator<I,K,V> ifIndexNot(final int... indexes);
    ...
    public ILevel2MapSelectedEntriesSelectedKeyOperator<I,K,V> execIfNotNull(final IFunction<? super K,? extends K> function);
