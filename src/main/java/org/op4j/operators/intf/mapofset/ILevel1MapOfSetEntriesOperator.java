...
public interface ILevel1MapOfSetEntriesOperator<K,V>
    ...
    public <X,Y> ILevel1MapOfSetEntriesOperator<X,Y> of(final IOf<X> ofX, final IOf<Y> ofY);
    public <X,Y> ILevel1MapOfSetEntriesOperator<X,Y> of(final Class<X> ofXClass, final Class<Y> ofYClass);
