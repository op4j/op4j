...
public interface Level1MapOfListSelectedEntriesSelectedOperator<K,V>
    ...
    public Level1MapOfListSelectedEntriesSelectedOperator<K,V> exec(final IFunction<? extends Map.Entry<K,List<V>>, ? super Map.Entry<K,List<V>>> function);
    
    public Level1MapOfListSelectedEntriesSelectedOperator<K,V> eval(final IEvaluator<? extends Map.Entry<K,List<V>>, ? super Map.Entry<K,List<V>>> eval);
    
    public Level1MapOfListSelectedEntriesSelectedOperator<K,V> convert(final IConverter<? extends Map.Entry<K,List<V>>, ? super Map.Entry<K,List<V>>> converter);
