...
public interface ILevel0MapOfListOperator<K,V>
		extends IUniqOperator<Map<K,List<V>>>,
                ...
                IExecutableOperator<Map<K,List<V>>>,
                IConvertibleOperator<Map<K,List<V>>>,
                ICallableOperator<Map<K,List<V>>>,
                IEvaluableOperator<Map<K,List<V>>>,
    ...
    public <X> ILevel0GenericUniqOperator<X> call(final IMethodCaller<X,? super Map<K,List<V>>> call);
