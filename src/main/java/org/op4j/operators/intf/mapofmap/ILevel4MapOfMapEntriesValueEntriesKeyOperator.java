...
public interface ILevel4MapOfMapEntriesValueEntriesKeyOperator<K1,K2,V>
    ...
    public <X> ILevel4MapOfMapEntriesValueEntriesKeyOperator<K1,X,V> of(final IOf<X> of);
    
    public <X> ILevel4MapOfMapEntriesValueEntriesKeyOperator<K1,X,V> of(final Class<X> classOf);
