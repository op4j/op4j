 ...
 *
 */
public interface Level2MapOfMapEntriesValueSelectedOperator<K1,K2,V>
    ...
    public Level2MapOfMapEntriesValueSelectedOperator<K1,K2,V> sort(final Comparator<? super Map.Entry<K2,V>> comparator);
    ...
    public Level2MapOfMapEntriesValueSelectedOperator<K1,K2,V> removeAllTrue(final IFunction<Boolean, ? super Map.Entry<K2,V>> eval);
    public Level2MapOfMapEntriesValueSelectedOperator<K1,K2,V> removeAllFalse(final IFunction<Boolean, ? super Map.Entry<K2,V>> eval);
