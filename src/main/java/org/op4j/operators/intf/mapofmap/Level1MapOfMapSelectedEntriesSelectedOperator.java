...
public interface Level1MapOfMapSelectedEntriesSelectedOperator<K1,K2,V>
    ...
    public Level1MapOfMapSelectedEntriesSelectedOperator<K1,K2,V> execIfNotNullAsMapOfMapEntry(final IFunction<? extends Map.Entry<? extends K1,? extends Map<? extends K2,? extends V>>,? super Map.Entry<K1,Map<K2,V>>> function);
