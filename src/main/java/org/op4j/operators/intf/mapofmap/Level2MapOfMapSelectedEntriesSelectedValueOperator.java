...
public interface Level2MapOfMapSelectedEntriesSelectedValueOperator<K1,K2,V>
    ...
    public Level2MapOfMapSelectedEntriesSelectedValueOperator<K1,K2,V> removeMatching(final IEvaluator<Boolean, ? super Map.Entry<K2,V>> eval);
    public Level2MapOfMapSelectedEntriesSelectedValueOperator<K1,K2,V> removeNotMatching(final IEvaluator<Boolean, ? super Map.Entry<K2,V>> eval);
