 ...
 *
 */
public interface Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V,I>
    ...
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesSelectedOperator<K1,K2,V,I> ifTrue(final IEvaluator<Boolean, ? super Map.Entry<K2, V>> eval);
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesSelectedOperator<K1,K2,V,I> ifFalse(final IEvaluator<Boolean, ? super Map.Entry<K2, V>> eval);
    ...
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V,I> replaceWith(final Map.Entry<K2,V> replacement);


    public Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V,I> exec(final IFunction<? extends Map.Entry<? extends K2,? extends V>, ? super Map.Entry<K2,V>> function);
    
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V,I> eval(final IEvaluator<? extends Map.Entry<? extends K2,? extends V>,? super Map.Entry<K2,V>> eval);
    
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V,I> convert(final IConverter<? extends Map.Entry<? extends K2,? extends V>,? super Map.Entry<K2,V>> converter);
