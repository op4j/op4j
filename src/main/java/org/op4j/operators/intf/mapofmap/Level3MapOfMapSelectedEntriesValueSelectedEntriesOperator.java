...
public interface Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V>
    ...
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesSelectedOperator<K1,K2,V> ifMatching(final IEvaluator<Boolean, ? super Map.Entry<K2, V>> eval);
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesSelectedOperator<K1,K2,V> ifNotMatching(final IEvaluator<Boolean, ? super Map.Entry<K2, V>> eval);
