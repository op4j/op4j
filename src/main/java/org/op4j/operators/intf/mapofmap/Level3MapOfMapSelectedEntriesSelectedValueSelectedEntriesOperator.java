...
public interface Level3MapOfMapSelectedEntriesSelectedValueSelectedEntriesOperator<K1,K2,V>
    ...
    public Level3MapOfMapSelectedEntriesSelectedValueSelectedEntriesOperator<K1,K2,V> exec(final IFunction<? extends Map.Entry<K2,V>, ? super Map.Entry<K2,V>> function);
    
    public Level3MapOfMapSelectedEntriesSelectedValueSelectedEntriesOperator<K1,K2,V> eval(final IEvaluator<? extends Map.Entry<K2,V>,? super Map.Entry<K2,V>> eval);
    
    public Level3MapOfMapSelectedEntriesSelectedValueSelectedEntriesOperator<K1,K2,V> convert(final IConverter<? extends Map.Entry<K2,V>,? super Map.Entry<K2,V>> converter);
