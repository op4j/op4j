...
public interface Level3MapOfMapSelectedEntriesValueSelectedEntriesSelectedOperator<K1,K2,V>
    ...
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesSelectedOperator<K1,K2,V> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<? extends K2,? extends V>,? super Map.Entry<K2,V>> function);
