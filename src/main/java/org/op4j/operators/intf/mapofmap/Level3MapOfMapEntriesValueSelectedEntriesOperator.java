...
public interface Level3MapOfMapEntriesValueSelectedEntriesOperator<K1,K2,V>
    ...
    public Level3MapOfMapEntriesValueSelectedEntriesSelectedOperator<K1,K2,V> ifTrue(final IFunction<Boolean, ? super Map.Entry<K2, V>> eval);
    public Level3MapOfMapEntriesValueSelectedEntriesSelectedOperator<K1,K2,V> ifFalse(final IFunction<Boolean, ? super Map.Entry<K2, V>> eval);
    ...
    public Level3MapOfMapEntriesValueSelectedEntriesOperator<K1,K2,V> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<? extends K2,? extends V>,? super Map.Entry<K2,V>> function);
