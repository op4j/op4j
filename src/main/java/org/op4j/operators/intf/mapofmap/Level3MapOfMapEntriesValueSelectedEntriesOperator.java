 ...
 *
 */
public interface Level3MapOfMapEntriesValueSelectedEntriesOperator<K1,K2,V>
    ...
    public Level3MapOfMapEntriesValueSelectedEntriesSelectedOperator<K1,K2,V> ifTrue(final IEvaluator<Boolean, ? super Map.Entry<K2, V>> eval);
    public Level3MapOfMapEntriesValueSelectedEntriesSelectedOperator<K1,K2,V> ifFalse(final IEvaluator<Boolean, ? super Map.Entry<K2, V>> eval);
    ...
    public Level3MapOfMapEntriesValueSelectedEntriesOperator<K1,K2,V> replaceWith(final Map.Entry<K2,V> replacement);


    public Level3MapOfMapEntriesValueSelectedEntriesOperator<K1,K2,V> execAsMapEntry(final IFunction<? extends Map.Entry<? extends K2,? extends V>, ? super Map.Entry<K2,V>> function);
    
    public Level3MapOfMapEntriesValueSelectedEntriesOperator<K1,K2,V> evalAsMapEntry(final IEvaluator<? extends Map.Entry<? extends K2,? extends V>,? super Map.Entry<K2,V>> eval);
    
    public Level3MapOfMapEntriesValueSelectedEntriesOperator<K1,K2,V> convertAsMapEntry(final IConverter<? extends Map.Entry<? extends K2,? extends V>,? super Map.Entry<K2,V>> converter);
