 ...
 *
 */
public interface Level2MapOfMapEntriesSelectedValueSelectedOperator<K1,K2,V,I>
    ...
    public Level2MapOfMapEntriesSelectedValueSelectedOperator<K1,K2,V,I> sort(final Comparator<? super Map.Entry<K2,V>> comparator);
    ...
    public Level2MapOfMapEntriesSelectedValueSelectedOperator<K1,K2,V,I> removeAllTrue(final IEvaluator<Boolean, ? super Map.Entry<K2,V>> eval);
    public Level2MapOfMapEntriesSelectedValueSelectedOperator<K1,K2,V,I> removeAllFalse(final IEvaluator<Boolean, ? super Map.Entry<K2,V>> eval);
