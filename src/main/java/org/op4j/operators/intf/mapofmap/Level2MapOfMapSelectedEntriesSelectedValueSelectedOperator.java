...
public interface Level2MapOfMapSelectedEntriesSelectedValueSelectedOperator<K1,K2,V>
    ...
    public Level2MapOfMapSelectedEntriesSelectedValueSelectedOperator<K1,K2,V> removeAllTrue(final IEvaluator<Boolean, ? super Map.Entry<K2,V>> eval);
    public Level2MapOfMapSelectedEntriesSelectedValueSelectedOperator<K1,K2,V> removeAllFalse(final IEvaluator<Boolean, ? super Map.Entry<K2,V>> eval);
