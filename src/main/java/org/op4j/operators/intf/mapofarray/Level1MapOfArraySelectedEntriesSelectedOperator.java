...
public interface Level1MapOfArraySelectedEntriesSelectedOperator<K,V>
    ...
    public Level1MapOfArraySelectedEntriesSelectedOperator<K,V> exec(final IFunction<? extends Map.Entry<K,V[]>, ? super Map.Entry<K,V[]>> function);
    
    public Level1MapOfArraySelectedEntriesSelectedOperator<K,V> eval(final IEvaluator<? extends Map.Entry<K,V[]>, ? super Map.Entry<K,V[]>> eval);
    
    public Level1MapOfArraySelectedEntriesSelectedOperator<K,V> convert(final IConverter<? extends Map.Entry<K,V[]>, ? super Map.Entry<K,V[]>> converter);
