...
public interface Level1MapOfArraySelectedEntriesOperator<K,V>
    ...
    public Level1MapOfArraySelectedEntriesSelectedOperator<K,V> ifTrue(final IFunction<Boolean, ? super Map.Entry<K,V[]>> eval);
    public Level1MapOfArraySelectedEntriesSelectedOperator<K,V> ifFalse(final IFunction<Boolean, ? super Map.Entry<K,V[]>> eval);
    ...
    public Level1MapOfArraySelectedEntriesOperator<K,V> execIfNotNullAsMapOfArrayEntry(final IFunction<? extends Map.Entry<? extends K,? extends V[]>, ? super Map.Entry<K,V[]>> function);
