...
public interface Level2ArrayOfMapElementsEntriesOperator<K,V> 
    ...
    public Level2ArrayOfMapElementsEntriesSelectedOperator<K,V> ifTrue(final IFunction<Boolean, ? super Map.Entry<K, V>> eval);
    public Level2ArrayOfMapElementsEntriesSelectedOperator<K,V> ifFalse(final IFunction<Boolean, ? super Map.Entry<K, V>> eval);
    ...
    public <X,Y> Level2ArrayOfMapElementsEntriesOperator<X,Y> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<X,Y>,? super Map.Entry<K,V>> function);
    ...
    public <X> Level2ArrayOfListElementsElementsOperator<X> execIfNotNull(final IFunction<X,? super Map.Entry<K,V>> function);
