 ...
 *
 */
public interface Level2ArrayOfMapSelectedElementsEntriesOperator<K,V,I> 
    ...
    public Level2ArrayOfMapSelectedElementsEntriesSelectedOperator<K,V,I> ifTrue(final IEvaluator<Boolean, ? super Map.Entry<K, V>> eval);
    public Level2ArrayOfMapSelectedElementsEntriesSelectedOperator<K,V,I> ifFalse(final IEvaluator<Boolean, ? super Map.Entry<K, V>> eval);
    ...
    public Level2ArrayOfMapSelectedElementsEntriesOperator<K,V,I> replaceWith(final Map.Entry<K,V> replacement);

    public Level2ArrayOfMapSelectedElementsEntriesOperator<K,V,I> exec(final IFunction<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> function);
    
    public Level2ArrayOfMapSelectedElementsEntriesOperator<K,V,I> eval(final IEvaluator<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> eval);
    
    public Level2ArrayOfMapSelectedElementsEntriesOperator<K,V,I> convert(final IConverter<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> converter);
