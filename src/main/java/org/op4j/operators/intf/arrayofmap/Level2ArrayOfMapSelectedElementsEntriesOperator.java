...
public interface Level2ArrayOfMapSelectedElementsEntriesOperator<K,V> 
    ...
    public Level2ArrayOfMapSelectedElementsEntriesSelectedOperator<K,V> ifTrue(final IFunction<Boolean, ? super Map.Entry<K, V>> eval);
    public Level2ArrayOfMapSelectedElementsEntriesSelectedOperator<K,V> ifFalse(final IFunction<Boolean, ? super Map.Entry<K, V>> eval);
    ...
    public Level2ArrayOfMapSelectedElementsEntriesOperator<K,V> execAsMapEntry(final IFunction<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> function);
    
    public Level2ArrayOfMapSelectedElementsEntriesOperator<K,V> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> function);
