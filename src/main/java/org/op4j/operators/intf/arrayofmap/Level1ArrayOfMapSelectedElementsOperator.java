 ...
 *
 */
public interface Level1ArrayOfMapSelectedElementsOperator<K,V,I>
    ...
    public Level1ArrayOfMapSelectedElementsOperator<K,V,I> sort(final Comparator<? super Map.Entry<K,V>> comparator);
    ...
    public Level1ArrayOfMapSelectedElementsOperator<K,V,I> removeAllTrue(final IEvaluator<Boolean, ? super Map.Entry<K,V>> eval);
    public Level1ArrayOfMapSelectedElementsOperator<K,V,I> removeAllFalse(final IEvaluator<Boolean, ? super Map.Entry<K,V>> eval);
