...
public interface Level2SetOfMapElementsEntriesSelectedOperator<K,V> 
    ...
    public Level2SetOfMapElementsEntriesSelectedOperator<K,V> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> function);
