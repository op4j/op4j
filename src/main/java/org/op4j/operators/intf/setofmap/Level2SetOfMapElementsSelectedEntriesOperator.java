...
public interface Level2SetOfMapElementsSelectedEntriesOperator<K,V> 
    ...
    public Level2SetOfMapElementsSelectedEntriesOperator<K,V> exec(final IFunction<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> function);
    
    public Level2SetOfMapElementsSelectedEntriesOperator<K,V> eval(final IEvaluator<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> eval);
    
    public Level2SetOfMapElementsSelectedEntriesOperator<K,V> convert(final IConverter<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> converter);
