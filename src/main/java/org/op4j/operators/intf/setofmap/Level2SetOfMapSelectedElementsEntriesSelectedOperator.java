...
public interface Level2SetOfMapSelectedElementsEntriesSelectedOperator<K,V> 
    ...
    public Level2SetOfMapSelectedElementsEntriesSelectedOperator<K,V> execIfNotNullAsMapEntry(final IFunction<? extends Map.Entry<? extends K,? extends V>, ? super Map.Entry<K,V>> function);
