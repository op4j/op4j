...
public interface Level2SetOfMapSelectedElementsEntriesSelectedOperator<K,V> 
    ...
    public Level2SetOfMapSelectedElementsEntriesSelectedOperator<K,V> exec(final IFunction<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> function);
    
    public Level2SetOfMapSelectedElementsEntriesSelectedOperator<K,V> eval(final IEvaluator<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> eval);
    
    public Level2SetOfMapSelectedElementsEntriesSelectedOperator<K,V> convert(final IConverter<? extends Map.Entry<K,V>, ? super Map.Entry<K,V>> converter);
