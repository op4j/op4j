...
public class Level0SetOperator<T> extends Operator
    ...
    public ILevel1SetElementsOperator<T> forEachIndex(final int... indices) {
        return new Level1SetElementsOperator<T>(getTarget().iterateIndex(indices));
    }
