 ...
 *
 */
public final class Level3SetOfMapElementsEntriesKeyOperatorImpl<K,V> extends AbstractOperatorImpl
    ...
    public <X> Level3SetOfMapElementsEntriesKeyOperator<X, V> execIfNotNull(final IFunction<X, ? super K> function) {
        return new Level3SetOfMapElementsEntriesKeyOperatorImpl<X, V>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
