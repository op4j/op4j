...
public class Level2SetOfMapElementsEntriesSelectedOperatorImpl<K,V> extends AbstractOperatorImpl implements Level2SetOfMapElementsEntriesSelectedOperator<K,V> {
    ...
    public Level2SetOfMapElementsEntriesSelectedOperator<K,V> replaceBy(final Entry<K,V> replacement) {
        return new Level2SetOfMapElementsEntriesSelectedOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
