...
public final class Level0SetOfMapSelectedOperatorImpl<K,V> extends AbstractOperatorImpl implements Level0SetOfMapSelectedOperator<K,V> {
    ...
    public Level0SetOfMapSelectedOperator<K,V> removeAllTrue(final IFunction<Boolean,? super Map<K,V>> eval) {
        return new Level0SetOfMapSelectedOperatorImpl<K,V>(getTarget().execute(new SetFuncs.RemoveAllTrue<Map<K,V>>(eval)));
    }


    public Level0SetOfMapSelectedOperator<K,V> removeAllFalse(final IFunction<Boolean,? super Map<K,V>> eval) {
        return new Level0SetOfMapSelectedOperatorImpl<K,V>(getTarget().execute(new SetFuncs.RemoveAllFalse<Map<K,V>>(eval)));
    }


    public Level0SetOfMapSelectedOperator<K,V> removeAllNullOrFalse(final IFunction<Boolean,? super Map<K,V>> eval) {
        return new Level0SetOfMapSelectedOperatorImpl<K,V>(getTarget().execute(new SetFuncs.RemoveAllNullOrFalse<Map<K,V>>(eval)));
    }


    public Level0SetOfMapSelectedOperator<K,V> removeAllNotNullAndFalse(final IFunction<Boolean,? super Map<K,V>> eval) {
        return new Level0SetOfMapSelectedOperatorImpl<K,V>(getTarget().execute(new SetFuncs.RemoveAllNotNullAndFalse<Map<K,V>>(eval)));
    }


    public Level0SetOfMapSelectedOperator<K,V> removeAllNotNullAndTrue(final IFunction<Boolean,? super Map<K,V>> eval) {
        return new Level0SetOfMapSelectedOperatorImpl<K,V>(getTarget().execute(new SetFuncs.RemoveAllNotNullAndTrue<Map<K,V>>(eval)));
    }


    public Level0SetOfMapSelectedOperator<K,V> removeAllNullOrTrue(final IFunction<Boolean,? super Map<K,V>> eval) {
    ...
    public Level0SetOfMapSelectedOperator<K,V> execIfNotNullAsSetOfMap(final IFunction<? extends Set<? extends Map<? extends K,? extends V>>,? super Set<Map<K,V>>> function) {
        return new Level0SetOfMapSelectedOperatorImpl<K,V>(getTarget().executeIfNotNull(function, Normalisation.SET_OF_MAP));
    }
    ...
    public Level0SetOfMapSelectedOperator<K,V> replaceWith(final Set<Map<K,V>> replacement) {
        return new Level0SetOfMapSelectedOperatorImpl<K,V>(getTarget().replaceWith(replacement, Normalisation.SET_OF_MAP));
    }
