...
public class Level3SetOfMapSelectedElementsEntriesKeySelectedOperatorImpl<K,V> extends AbstractOperatorImpl implements Level3SetOfMapSelectedElementsEntriesKeySelectedOperator<K,V> {
    ...
    public Level3SetOfMapSelectedElementsEntriesKeySelectedOperator<K,V> replaceBy(final K replacement) {
        return new Level3SetOfMapSelectedElementsEntriesKeySelectedOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
