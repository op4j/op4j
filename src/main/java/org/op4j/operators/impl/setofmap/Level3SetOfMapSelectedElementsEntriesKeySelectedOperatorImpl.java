...
public class Level3SetOfMapSelectedElementsEntriesKeySelectedOperatorImpl<K,V,I> extends AbstractOperatorImpl implements Level3SetOfMapSelectedElementsEntriesKeySelectedOperator<K,V,I> {
    ...
    public Level3SetOfMapSelectedElementsEntriesKeySelectedOperator<K,V,I> eval(final IEvaluator<? extends K,? super K> eval) {
        return new Level3SetOfMapSelectedElementsEntriesKeySelectedOperatorImpl<K,V,I>(getTarget().execute(eval, Normalization.NONE));
    }


    public Level3SetOfMapSelectedElementsEntriesKeyOperator<K,V,I> endIf() {
        return new Level3SetOfMapSelectedElementsEntriesKeyOperatorImpl<K,V,I>(getTarget().endSelect());
    }


    public Level3SetOfMapSelectedElementsEntriesKeySelectedOperator<K,V,I> exec(final IFunction<? extends K,? super K> function) {
        return new Level3SetOfMapSelectedElementsEntriesKeySelectedOperatorImpl<K,V,I>(getTarget().execute(function, Normalization.NONE));
    }


    public Level3SetOfMapSelectedElementsEntriesKeySelectedOperator<K,V,I> replaceWith(final K replacement) {
        return new Level3SetOfMapSelectedElementsEntriesKeySelectedOperatorImpl<K,V,I>(getTarget().replaceWith(replacement));
    }
    ...
    public Level3SetOfMapSelectedElementsEntriesKeySelectedOperator<K,V,I> convert(final IConverter<? extends K,? super K> converter) {
        return new Level3SetOfMapSelectedElementsEntriesKeySelectedOperatorImpl<K,V,I>(getTarget().execute(converter, Normalization.NONE));
    }
