...
public class Level2SetOfMapSelectedElementsEntriesOperatorImpl<K,V> extends AbstractOperatorImpl implements Level2SetOfMapSelectedElementsEntriesOperator<K,V> {
    ...
    public Level2SetOfMapSelectedElementsEntriesOperator<K,V> replaceBy(final Entry<K,V> replacement) {
        return new Level2SetOfMapSelectedElementsEntriesOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
