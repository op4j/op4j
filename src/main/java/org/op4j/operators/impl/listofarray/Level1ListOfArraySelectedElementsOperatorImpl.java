...
public class Level1ListOfArraySelectedElementsOperatorImpl<T> extends AbstractOperatorImpl implements Level1ListOfArraySelectedElementsOperator<T> {
    ...
    public Level1ListOfArraySelectedElementsSelectedOperator<T> ifIndex(final int... indexes) {
        return new Level1ListOfArraySelectedElementsSelectedOperatorImpl<T>(getTarget().selectIndex(indexes));
    }
    ...
    public Level1ListOfArraySelectedElementsSelectedOperator<T> ifIndexNot(final int... indexes) {
        return new Level1ListOfArraySelectedElementsSelectedOperatorImpl<T>(getTarget().selectIndexNot(indexes));
    }
    ...
    public Level2ListOfArraySelectedElementsElementsOperator<T> forEach(final Type<T> elementType) {
        return new Level2ListOfArraySelectedElementsElementsOperatorImpl<T>(elementType, getTarget().iterate(Structure.ARRAY));
    }
    ...
    public Level1ListOfArraySelectedElementsOperator<T> removeAllIndexes(final int... indexes) {
        return new Level1ListOfArraySelectedElementsOperatorImpl<T>(getTarget().execute(new ArrayFuncs.RemoveAllIndexes<T>(indexes)));
    }
    ...
    public Level1ListOfArraySelectedElementsOperator<T> removeAllIndexesNot(final int... indexes) {
        return new Level1ListOfArraySelectedElementsOperatorImpl<T>(getTarget().execute(new ArrayFuncs.RemoveAllIndexesNot<T>(indexes)));
    }
    ...
    public Level1ListOfArraySelectedElementsOperator<T> convertAsArray(final IConverter<? extends T[],? super T[]> converter) {
        return new Level1ListOfArraySelectedElementsOperatorImpl<T>(getTarget().execute(converter, Normalisation.ARRAY));
    }


    public Level1ListOfArraySelectedElementsOperator<T> evalAsArray(final IEvaluator<? extends T[],? super T[]> eval) {
        return new Level1ListOfArraySelectedElementsOperatorImpl<T>(getTarget().execute(eval, Normalisation.ARRAY));
    }


    public Level1ListOfArraySelectedElementsOperator<T> execAsArray(final IFunction<? extends T[],? super T[]> function) {
        return new Level1ListOfArraySelectedElementsOperatorImpl<T>(getTarget().execute(function, Normalisation.ARRAY));
    }


    public Level0ListOfArraySelectedOperator<T> endFor() {
        return new Level0ListOfArraySelectedOperatorImpl<T>(getTarget().endIterate(null));
    }
