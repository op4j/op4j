...
public class Level2ListOfArrayElementsElementsOperator<T> extends Operator
    ...
    public <X> ILevel2ListOfArrayElementsElementsOperator<X> conv(final IConv<X> conv) {
        return new Level2ListOfArrayElementsElementsOperator<X>(conv.getResultType(), getTarget().execute(conv));
    }

    public <X> ILevel2ListOfArrayElementsElementsOperator<X> convTo(final Type<X> resultType, final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<X>(resultType, getTarget().execute(Conv.to(resultType, parameters)));
    }

    public ILevel2ListOfArrayElementsElementsOperator<BigDecimal> convToBigDecimal(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<BigDecimal>(Types.BIG_DECIMAL, getTarget().execute(Conv.to(Types.BIG_DECIMAL, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<BigInteger> convToBigInteger(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<BigInteger>(Types.BIG_INTEGER, getTarget().execute(Conv.to(Types.BIG_INTEGER, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<Boolean> convToBoolean(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Boolean>(Types.BOOLEAN, getTarget().execute(Conv.to(Types.BOOLEAN, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<Byte> convToByte(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Byte>(Types.BYTE, getTarget().execute(Conv.to(Types.BYTE, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<Calendar> convToCalendar(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Calendar>(Types.CALENDAR, getTarget().execute(Conv.to(Types.CALENDAR, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<Double> convToDouble(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Double>(Types.DOUBLE, getTarget().execute(Conv.to(Types.DOUBLE, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<Float> convToFloat(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Float>(Types.FLOAT, getTarget().execute(Conv.to(Types.FLOAT, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<Integer> convToInteger(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Integer>(Types.INTEGER, getTarget().execute(Conv.to(Types.INTEGER, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<Long> convToLong(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Long>(Types.LONG, getTarget().execute(Conv.to(Types.LONG, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<Short> convToShort(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Short>(Types.SHORT, getTarget().execute(Conv.to(Types.SHORT, parameters)));
    }


    public ILevel2ListOfArrayElementsElementsOperator<String> convToString(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<String>(Types.STRING, getTarget().execute(Conv.to(Types.STRING, parameters)));
    }

    public ILevel2ListOfArrayElementsElementsOperator<Character> convToCharacter(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Character>(Types.CHARACTER, getTarget().execute(Conv.to(Types.CHARACTER, parameters)));
    }

    public ILevel2ListOfArrayElementsElementsOperator<Number> convToNumber(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Number>(Types.NUMBER, getTarget().execute(Conv.to(Types.NUMBER, parameters)));
    }

    public ILevel2ListOfArrayElementsElementsOperator<Date> convToDate(final Object... parameters) {
        return new Level2ListOfArrayElementsElementsOperator<Date>(Types.DATE, getTarget().execute(Conv.to(Types.DATE, parameters)));
    }
