...
public class Level1MapOfSetSelectedEntriesOperatorImpl<K,V> extends AbstractOperatorImpl implements Level1MapOfSetSelectedEntriesOperator<K,V> {
    ...
    public Level2MapOfSetSelectedEntriesKeyOperator<K,V> onKey() {
        return new Level2MapOfSetSelectedEntriesKeyOperatorImpl<K,V>(getTarget().iterate().selectIndex(0));
    }


    public Level2MapOfSetSelectedEntriesValueOperator<K,V> onValue() {
        return new Level2MapOfSetSelectedEntriesValueOperatorImpl<K,V>(getTarget().iterate().selectIndex(1));
    }
    ...
    public Level1MapOfSetSelectedEntriesOperator<K,V> replaceWith(final Entry<K,Set<V>> replacement) {
        return new Level1MapOfSetSelectedEntriesOperatorImpl<K,V>(getTarget().replaceWith(replacement));
    }
