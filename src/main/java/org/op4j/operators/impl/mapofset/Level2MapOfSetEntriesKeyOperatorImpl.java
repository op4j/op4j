...
public final class Level2MapOfSetEntriesKeyOperatorImpl<K,V> extends AbstractOperatorImpl
    ...
    public <X> Level2MapOfSetEntriesKeyOperator<X, V> execIfNotNull(final IFunction<X, ? super K> function) {
        return new Level2MapOfSetEntriesKeyOperatorImpl<X, V>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
    ...
    public Level2MapOfSetEntriesKeyOperator<K, V> replaceWith(final K replacement) {
        return new Level2MapOfSetEntriesKeyOperatorImpl<K, V>(getTarget().replaceWith(replacement, Normalisation.NONE));
    }
