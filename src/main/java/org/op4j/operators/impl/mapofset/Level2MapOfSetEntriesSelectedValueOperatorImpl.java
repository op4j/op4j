...
public class Level2MapOfSetEntriesSelectedValueOperatorImpl<K,V> extends AbstractOperatorImpl implements Level2MapOfSetEntriesSelectedValueOperator<K,V> {
    ...
    public Level2MapOfSetEntriesSelectedValueOperator<K,V> distinct() {
        return null;
    }
    ...
    public Level2MapOfSetEntriesSelectedValueOperator<K,V> eval(final IEvaluator<? extends Set<V>,? super Set<V>> eval) {
        return null;
    }
    ...
    public Level2MapOfSetEntriesSelectedValueOperator<K,V> exec(final IFunction<? extends Set<V>,? super Set<V>> function) {
        return null;
    }
    ...
    public Level2MapOfSetEntriesSelectedValueOperator<K,V> convert(final IConverter<? extends Set<V>,? super Set<V>> converter) {
        return null;
    }
