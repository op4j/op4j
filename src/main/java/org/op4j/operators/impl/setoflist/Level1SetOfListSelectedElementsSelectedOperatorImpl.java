...
public final class Level1SetOfListSelectedElementsSelectedOperatorImpl<T> extends AbstractOperatorImpl implements Level1SetOfListSelectedElementsSelectedOperator<T> {
    ...
    public Level1SetOfListSelectedElementsSelectedOperator<T> execIfNotNullAsList(final IFunction<? extends List<? extends T>,? super List<T>> function) {
        return new Level1SetOfListSelectedElementsSelectedOperatorImpl<T>(getTarget().executeIfNotNull(function, Normalisation.LIST));
    }
    ...
    public Level1SetOfListSelectedElementsSelectedOperator<T> replaceWith(final List<T> replacement) {
        return new Level1SetOfListSelectedElementsSelectedOperatorImpl<T>(getTarget().replaceWith(replacement, Normalisation.LIST));
    }
