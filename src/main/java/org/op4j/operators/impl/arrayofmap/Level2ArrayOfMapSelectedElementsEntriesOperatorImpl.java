...
public class Level2ArrayOfMapSelectedElementsEntriesOperatorImpl<K,V> extends AbstractOperatorImpl implements Level2ArrayOfMapSelectedElementsEntriesOperator<K,V> {
    ...
    public Level2ArrayOfMapSelectedElementsEntriesOperator<K,V> replaceBy(final Entry<K,V> replacement) {
        return new Level2ArrayOfMapSelectedElementsEntriesOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
    ...
    public Level1ArrayOfMapSelectedElementsOperator<K,V> endFor() {
        return new Level1ArrayOfMapSelectedElementsOperatorImpl<K,V>(getTarget().endIterate(Structure.MAP, null));
    }
    ...
    public Level3ArrayOfMapSelectedElementsEntriesKeyOperator<K,V> onKey() {
        return new Level3ArrayOfMapSelectedElementsEntriesKeyOperatorImpl<K,V>(getTarget().iterateIndex(0));
    }


    public Level3ArrayOfMapSelectedElementsEntriesValueOperator<K,V> onValue() {
        return new Level3ArrayOfMapSelectedElementsEntriesValueOperatorImpl<K,V>(getTarget().iterateIndex(1));
    }
