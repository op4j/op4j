...
public final class Level1ArrayOfMapElementsSelectedOperatorImpl<K,V> extends AbstractOperatorImpl implements Level1ArrayOfMapElementsSelectedOperator<K,V> {
    ...
    public Level1ArrayOfMapElementsSelectedOperator<K,V> removeAllTrue(final IFunction<Boolean,? super Entry<K,V>> eval) {
        return new Level1ArrayOfMapElementsSelectedOperatorImpl<K,V>(getTarget().execute(new MapFuncs.RemoveAllTrue<K,V>(eval)));
    }


    public Level1ArrayOfMapElementsSelectedOperator<K,V> removeAllFalse(final IFunction<Boolean,? super Entry<K,V>> eval) {
    ...
    public Level1ArrayOfMapElementsSelectedOperator<K,V> execIfNotNullAsMap(final IFunction<? extends Map<? extends K,? extends V>,? super Map<K,V>> function) {
        return new Level1ArrayOfMapElementsSelectedOperatorImpl<K,V>(getTarget().executeIfNotNull(function, Normalisation.MAP));
    }
    ...
    public Level1ArrayOfMapElementsSelectedOperator<K,V> replaceWith(final Map<K,V> replacement) {
        return new Level1ArrayOfMapElementsSelectedOperatorImpl<K,V>(getTarget().replaceWith(replacement, Normalisation.MAP));
    }
