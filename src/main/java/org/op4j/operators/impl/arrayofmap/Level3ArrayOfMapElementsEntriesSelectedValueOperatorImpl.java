...
public class Level3ArrayOfMapElementsEntriesSelectedValueOperatorImpl<K,V> extends AbstractOperatorImpl implements Level3ArrayOfMapElementsEntriesSelectedValueOperator<K,V> {
    ...
    public Level3ArrayOfMapElementsEntriesSelectedValueOperator<K,V> replaceBy(final V replacement) {
        return new Level3ArrayOfMapElementsEntriesSelectedValueOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
