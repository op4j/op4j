...
public class Level2ArrayOfMapElementsSelectedEntriesSelectedOperatorImpl<K,V> extends AbstractOperatorImpl implements Level2ArrayOfMapElementsSelectedEntriesSelectedOperator<K,V> {
    ...
    public Level2ArrayOfMapElementsSelectedEntriesSelectedOperator<K,V> replaceBy(final Entry<K,V> replacement) {
        return new Level2ArrayOfMapElementsSelectedEntriesSelectedOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
