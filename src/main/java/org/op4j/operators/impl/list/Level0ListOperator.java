...
public class Level0ListOperator<T> extends Operator
    ...
    public ILevel0ListOperator<T> removeMatching(final String expression, final Object... optionalExpParams) {
        return new Level0ListOperator<T>(getTarget().execute(new ListFuncs.RemoveMatching<T>(Eval.booleanExp(expression, optionalExpParams))));
    }
    ...
    public ILevel0ListOperator<T> removeNotNullMatching(final String expression, final Object... optionalExpParams) {
        return new Level0ListOperator<T>(getTarget().execute(new ListFuncs.RemoveNotNullMatching<T>(Eval.booleanExp(expression, optionalExpParams))));
    }


    public ILevel0ListOperator<T> removeNullOrMatching(final String expression, final Object... optionalExpParams) {
        return new Level0ListOperator<T>(getTarget().execute(new ListFuncs.RemoveNullOrMatching<T>(Eval.booleanExp(expression, optionalExpParams))));
    }
