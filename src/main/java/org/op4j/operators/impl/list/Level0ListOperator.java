...
public class Level0ListOperator<T> extends Operator
    ...
    public ILevel1ListElementsOperator<T> forEachIndex(final int... indices) {
        return new Level1ListElementsOperator<T>(getTarget().iterateIndex(indices));
    }
