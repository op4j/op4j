...
public class Level1SetOfSetElementsOperator<T> extends Operator
    ...
    public ILevel1SetOfSetElementsOperator<T> add(final T... newElements) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.add(newElements)));
    }


    public ILevel1SetOfSetElementsOperator<T> insert(final int position, final T... newElements) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.insert(position, newElements)));
    }


    public ILevel1SetOfSetElementsOperator<T> addAll(final Collection<T> collection) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.addAll(collection)));
    }
    ...
    public ILevel1SetOfSetElementsOperator<T> removePositions(final int... positions) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.removePositions(positions)));
    }


    public ILevel1SetOfSetElementsOperator<T> removeValues(final T... values) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.removeValues(values)));
    }


    public ILevel1SetOfSetElementsOperator<T> removeMatching(final String expression, final Object... optionalExpParams) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.removeMatching(expression, optionalExpParams)));
    }


    public ILevel1SetOfSetElementsOperator<T> removeSelected(final ISelect<T> selector) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.removeSelected(selector)));
    }


    public ILevel1SetOfSetElementsOperator<T> removeAllExceptPositions(final int... positions) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.removeAllExceptPositions(positions)));
    }



    public ILevel1SetOfSetElementsOperator<T> removeNotNullsMatching(final String expression, final Object... optionalExpParams) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.removeNotNullsMatching(expression, optionalExpParams)));
    }


    public ILevel1SetOfSetElementsOperator<T> removeNulls() {
        return new Level1SetOfSetElementsOperator<T>(getTarget().execute(SetFuncOLD.removeNulls()));
    }
