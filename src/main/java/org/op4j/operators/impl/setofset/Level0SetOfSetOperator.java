...
public class Level0SetOfSetOperator<T> extends Operator
    ...
    public ILevel1SetOfSetElementsOperator<T> forEachIndex(final int... indices) {
        return new Level1SetOfSetElementsOperator<T>(getTarget().iterateIndex(indices));
    }
