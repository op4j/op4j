 ...
 *
 */
public final class Level2SetOfSetElementsElementsOperatorImpl<T> extends AbstractOperatorImpl
    ...
    public Level1SetOfSetElementsOperator<T> endFor() {
        return new Level1SetOfSetElementsOperatorImpl<T>(getTarget().endIterate(null));
    }
    ...
    public Level2SetOfSetElementsElementsSelectedOperator<T> ifIndex(final int... indexes) {
        return new Level2SetOfSetElementsElementsSelectedOperatorImpl<T>(getTarget().selectIndex(indexes));
    }


    public Level2SetOfSetElementsElementsSelectedOperator<T> ifIndexNot(final int... indexes) {
        return new Level2SetOfSetElementsElementsSelectedOperatorImpl<T>(getTarget().selectIndexNot(indexes));
    }
    ...
    public <X> Level2SetOfSetElementsElementsOperator<X> convert(final IConverter<X, ? super T> converter) {
        return new Level2SetOfSetElementsElementsOperatorImpl<X>(getTarget().execute(converter, Normalisation.NONE));
    }


    public <X> Level2SetOfSetElementsElementsOperator<X> eval(final IEvaluator<X, ? super T> eval) {
        return new Level2SetOfSetElementsElementsOperatorImpl<X>(getTarget().execute(eval, Normalisation.NONE));
    }


    public <X> Level2SetOfSetElementsElementsOperator<X> exec(final IFunction<X, ? super T> function) {
        return new Level2SetOfSetElementsElementsOperatorImpl<X>(getTarget().execute(function, Normalisation.NONE));
    }


    public Level2SetOfSetElementsElementsOperator<T> replaceWith(final T replacement) {
        return new Level2SetOfSetElementsElementsOperatorImpl<T>(getTarget().replaceWith(replacement, Normalisation.NONE));
    }
