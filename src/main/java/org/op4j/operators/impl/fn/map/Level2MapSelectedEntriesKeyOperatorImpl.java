...
public final class Level2MapSelectedEntriesKeyOperatorImpl<K,V,I> extends AbstractOperatorImpl implements UniqFnOperator<Map<K,V>,I>, Level2MapSelectedEntriesKeyOperator<K,V,I> {
