...
public final class Level2MapSelectedEntriesSelectedKeyOperatorImpl<K,V,I> extends AbstractOperatorImpl implements UniqFnOperator<Map<K,V>,I>, Level2MapSelectedEntriesSelectedKeyOperator<K,V,I> {
