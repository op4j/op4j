...
public final class Level1ArrayElementsSelectedOperatorImpl<T,I> extends AbstractOperatorImpl implements UniqFnOperator<T[],I>, Level1ArrayElementsSelectedOperator<T,I> {
