...
public final class Level1ListElementsSelectedOperatorImpl<T,I> extends AbstractOperatorImpl implements UniqFnOperator<List<T>,I>, Level1ListElementsSelectedOperator<T,I> {
