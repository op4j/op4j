...
public final class Level1ArraySelectedElementsOperatorImpl<T,I> extends AbstractOperatorImpl implements UniqFnOperator<T[],I>, Level1ArraySelectedElementsOperator<T,I> {
