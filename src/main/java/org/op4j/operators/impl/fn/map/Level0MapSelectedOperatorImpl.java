...
public final class Level0MapSelectedOperatorImpl<K,V,I> extends AbstractOperatorImpl implements UniqFnOperator<Map<K,V>,I>, Level0MapSelectedOperator<K,V,I> {
