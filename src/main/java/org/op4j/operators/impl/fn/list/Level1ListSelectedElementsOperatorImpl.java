...
public final class Level1ListSelectedElementsOperatorImpl<T,I> extends AbstractOperatorImpl implements UniqFnOperator<List<T>,I>, Level1ListSelectedElementsOperator<T,I> {
