...
public final class Level2MapSelectedEntriesValueOperatorImpl<K,V,I> extends AbstractOperatorImpl implements UniqFnOperator<Map<K,V>,I>, Level2MapSelectedEntriesValueOperator<K,V,I> {
