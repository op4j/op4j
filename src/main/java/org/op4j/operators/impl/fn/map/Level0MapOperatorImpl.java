...
public final class Level0MapOperatorImpl<K,V,I> extends AbstractOperatorImpl
        implements UniqFnOperator<Map<K,V>,I>, Level0MapOperator<K,V,I> {
    ...
    public Level0MapOperatorImpl<K, V,I> sort() {
        return new Level0MapOperatorImpl<K, V,I>(getTarget().execute(new FMap.SortByKey()));
    }


    public Level0MapOperatorImpl<K, V,I> sort(final Comparator<? super Entry<K, V>> comparator) {
    ...
    public Level0GenericUniqOperatorImpl<Map<K, V>,I> generic() {
    ...
    public <X, Y> Level0MapOperatorImpl<X, Y,I> asMapOf(final Type<X> keyType, final Type<Y> valueType) {
    ...
    public Level0MapSelectedOperatorImpl<K, V,I> ifIndex(final int... indexes) {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectIndex(indexes));
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifIndexNot(final int... indexes) {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectIndexNot(indexes));
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifTrue(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectMatching(eval));
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifFalse(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectNotMatching(eval));
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifNotNull() {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectNotNull());
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifNotNullAndTrue(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectNotNullAndMatching(eval));
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifNotNullAndFalse(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectNotNullAndNotMatching(eval));
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifNull() {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectNull());
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifNullOrTrue(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectNullOrMatching(eval));
    }


    public Level0MapSelectedOperatorImpl<K, V,I> ifNullOrFalse(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level0MapSelectedOperatorImpl<K, V,I>(getTarget().selectNullOrNotMatching(eval));
    }


    public Level0MapOperatorImpl<K, V,I> execIfNotNullAsMap(final IFunction<? extends Map<? extends K, ? extends V>, ? super Map<K, V>> function) {
        return new Level0MapOperatorImpl<K, V,I>(getTarget().executeIfNotNull(function, Normalisation.MAP));
    }


    public <X, Y> Level0MapOperatorImpl<X, Y,I> execAsMap(final IFunction<? extends Map<X, Y>, ? super Map<K, V>> function) {
    ...
    public <X> Level0GenericUniqOperatorImpl<X,I> exec(final IFunction<X, ? super Map<K, V>> function) {
        return new Level0GenericUniqOperatorImpl<X,I>(getTarget().execute(function, Normalisation.NONE));
    }


    public Level0MapOperatorImpl<K, V,I> replaceWith(final Map<K, V> replacement) {
        return new Level0MapOperatorImpl<K, V,I>(getTarget().replaceWith(replacement, Normalisation.MAP));
    }


    public Level0MapOperatorImpl<K, V,I> replaceIfNullWith(final Map<K, V> replacement) {
