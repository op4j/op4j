...
import org.op4j.operators.intf.list.ILevel1ListSelectedElementsOperator;
...
public final class Level1ListSelectedElementsOperator<I,T> extends AbstractOperator implements UniqFnOperator<I,List<T>>, ILevel1ListSelectedElementsOperator<I,T> {
    ...
    public Level1ListSelectedElementsOperator<I,T> execIfNotNull(final IFunction<? super T,? extends T> function) {
        return new Level1ListSelectedElementsOperator<I,T>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
