...
public class Level2MapOfMapEntriesKeySelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level2MapOfMapEntriesKeySelectedOperator<K1,K2,V> {
    ...
    public Level2MapOfMapEntriesKeySelectedOperator<K1,K2,V> replaceBy(final K1 replacement) {
        return new Level2MapOfMapEntriesKeySelectedOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
