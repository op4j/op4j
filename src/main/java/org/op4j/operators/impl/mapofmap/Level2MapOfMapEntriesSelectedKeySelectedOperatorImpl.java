...
public final class Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V> {
    ...
    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V> execIfNotNull(final IFunction<? extends K1,? super K1> function) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
