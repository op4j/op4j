...
public class Level4MapOfMapEntriesSelectedValueEntriesKeySelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level4MapOfMapEntriesSelectedValueEntriesKeySelectedOperator<K1,K2,V> {
    ...
    public Level4MapOfMapEntriesSelectedValueEntriesKeySelectedOperator<K1,K2,V> replaceBy(final K2 replacement) {
        return new Level4MapOfMapEntriesSelectedValueEntriesKeySelectedOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
