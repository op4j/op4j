...
public class Level4MapOfMapEntriesSelectedValueEntriesValueOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level4MapOfMapEntriesSelectedValueEntriesValueOperator<K1,K2,V> {
    ...
    public Level4MapOfMapEntriesSelectedValueEntriesValueOperator<K1,K2,V> replaceBy(final V replacement) {
        return new Level4MapOfMapEntriesSelectedValueEntriesValueOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
