 ...
 *
 */
public class Level4MapOfMapEntriesValueEntriesKeyOperatorImpl<K1,K2,V,I> extends AbstractOperatorImpl
        implements Level4MapOfMapEntriesValueEntriesKeyOperator<K1,K2,V,I> {
    ...
    public <X> Level4MapOfMapEntriesValueEntriesKeyOperator<K1, X, V,I> asType(final Type<X> type) {
        ...
        return new Level4MapOfMapEntriesValueEntriesKeyOperatorImpl<K1, X, V,I>(getTarget());
    }
    ...
    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifIndex(final int... indices) {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectIndex(indices));
    }


    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifIndexNot(final int... indices) {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectIndexNot(indices));
    }


    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifTrue(final IEvaluator<Boolean, ? super K2> eval) {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectMatching(eval));
    }


    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifFalse(final IEvaluator<Boolean, ? super K2> eval) {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectNotMatching(eval));
    }


    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifNotNull() {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectNotNull());
    }
    ...
    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifNotNullAndTrue(final IEvaluator<Boolean, ? super K2> eval) {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectNotNullAndMatching(eval));
    }
    ...
    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifNotNullAndFalse(final IEvaluator<Boolean, ? super K2> eval) {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectNotNullAndNotMatching(eval));
    }


    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifNull() {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectNull());
    }
    ...
    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifNullOrTrue(final IEvaluator<Boolean, ? super K2> eval) {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectNullOrMatching(eval));
    }
    ...
    public Level4MapOfMapEntriesValueEntriesKeySelectedOperator<K1, K2, V,I> ifNullOrFalse(final IEvaluator<Boolean, ? super K2> eval) {
        return new Level4MapOfMapEntriesValueEntriesKeySelectedOperatorImpl<K1, K2, V,I>(getTarget().selectNullOrNotMatching(eval));
    }


    public <X> Level4MapOfMapEntriesValueEntriesKeyOperator<K1, X, V,I> convert(final IConverter<X, ? super K2> converter) {
        return new Level4MapOfMapEntriesValueEntriesKeyOperatorImpl<K1, X, V,I>(getTarget().execute(converter, Normalization.NONE));
    }


    public <X> Level4MapOfMapEntriesValueEntriesKeyOperator<K1, X, V,I> eval(final IEvaluator<X, ? super K2> eval) {
        return new Level4MapOfMapEntriesValueEntriesKeyOperatorImpl<K1, X, V,I>(getTarget().execute(eval, Normalization.NONE));
    }


    public <X> Level4MapOfMapEntriesValueEntriesKeyOperator<K1, X, V,I> exec(final IFunction<X, ? super K2> function) {
        return new Level4MapOfMapEntriesValueEntriesKeyOperatorImpl<K1, X, V,I>(getTarget().execute(function, Normalization.NONE));
    }


    public Level4MapOfMapEntriesValueEntriesKeyOperator<K1, K2, V,I> replaceWith(final K2 replacement) {
        return new Level4MapOfMapEntriesValueEntriesKeyOperatorImpl<K1, K2, V,I>(getTarget().replaceWith(replacement));
    }
