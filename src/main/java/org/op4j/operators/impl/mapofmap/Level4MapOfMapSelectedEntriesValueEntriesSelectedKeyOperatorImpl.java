...
public class Level4MapOfMapSelectedEntriesValueEntriesSelectedKeyOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level4MapOfMapSelectedEntriesValueEntriesSelectedKeyOperator<K1,K2,V> {
    ...
    public Level4MapOfMapSelectedEntriesValueEntriesSelectedKeyOperator<K1,K2,V> replaceBy(final K2 replacement) {
        return new Level4MapOfMapSelectedEntriesValueEntriesSelectedKeyOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
