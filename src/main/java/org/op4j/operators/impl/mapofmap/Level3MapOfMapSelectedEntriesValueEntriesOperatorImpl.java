...
public class Level3MapOfMapSelectedEntriesValueEntriesOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level3MapOfMapSelectedEntriesValueEntriesOperator<K1,K2,V> {
    ...
    public Level3MapOfMapSelectedEntriesValueEntriesOperator<K1,K2,V> replaceBy(final Entry<K2,V> replacement) {
        return new Level3MapOfMapSelectedEntriesValueEntriesOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
