...
public final class Level2MapOfMapSelectedEntriesKeyOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level2MapOfMapSelectedEntriesKeyOperator<K1,K2,V> {
    ...
    public Level2MapOfMapSelectedEntriesKeySelectedOperator<K1,K2,V> ifTrue(final IFunction<Boolean, ? super K1> eval) {
        return new Level2MapOfMapSelectedEntriesKeySelectedOperatorImpl<K1,K2,V>(getTarget().selectMatching(eval));
    }


    public Level2MapOfMapSelectedEntriesKeySelectedOperator<K1,K2,V> ifFalse(final IFunction<Boolean, ? super K1> eval) {
        return new Level2MapOfMapSelectedEntriesKeySelectedOperatorImpl<K1,K2,V>(getTarget().selectNotMatching(eval));
    }


    public Level2MapOfMapSelectedEntriesKeySelectedOperator<K1,K2,V> ifNullOrFalse(final IFunction<Boolean, ? super K1> eval) {
        return new Level2MapOfMapSelectedEntriesKeySelectedOperatorImpl<K1,K2,V>(getTarget().selectNullOrNotMatching(eval));
    }


    public Level2MapOfMapSelectedEntriesKeySelectedOperator<K1,K2,V> ifNotNullAndFalse(final IFunction<Boolean, ? super K1> eval) {
    ...
    public Level2MapOfMapSelectedEntriesKeySelectedOperator<K1,K2,V> ifNullOrTrue(final IFunction<Boolean, ? super K1> eval) {
    ...
    public Level2MapOfMapSelectedEntriesKeySelectedOperator<K1,K2,V> ifNotNullAndTrue(final IFunction<Boolean, ? super K1> eval) {
        return new Level2MapOfMapSelectedEntriesKeySelectedOperatorImpl<K1,K2,V>(getTarget().selectNotNullAndMatching(eval));
    }


    public Level2MapOfMapSelectedEntriesKeyOperator<K1,K2,V> execIfNotNull(final IFunction<? extends K1,? super K1> function) {
        return new Level2MapOfMapSelectedEntriesKeyOperatorImpl<K1,K2,V>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
