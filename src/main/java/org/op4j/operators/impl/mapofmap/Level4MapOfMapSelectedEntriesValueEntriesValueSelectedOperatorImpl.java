...
public class Level4MapOfMapSelectedEntriesValueEntriesValueSelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level4MapOfMapSelectedEntriesValueEntriesValueSelectedOperator<K1,K2,V> {
    ...
    public Level4MapOfMapSelectedEntriesValueEntriesValueSelectedOperator<K1,K2,V> replaceBy(final V replacement) {
        return new Level4MapOfMapSelectedEntriesValueEntriesValueSelectedOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
