...
public class Level4MapOfMapEntriesValueEntriesSelectedKeySelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level4MapOfMapEntriesValueEntriesSelectedKeySelectedOperator<K1,K2,V> {
    ...
    public Level4MapOfMapEntriesValueEntriesSelectedKeySelectedOperator<K1,K2,V> replaceBy(final K2 replacement) {
        return new Level4MapOfMapEntriesValueEntriesSelectedKeySelectedOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
