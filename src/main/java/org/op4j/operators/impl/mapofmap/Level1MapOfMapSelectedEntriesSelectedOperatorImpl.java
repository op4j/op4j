...
public class Level1MapOfMapSelectedEntriesSelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level1MapOfMapSelectedEntriesSelectedOperator<K1,K2,V> {
    ...
    public Level1MapOfMapSelectedEntriesSelectedOperator<K1,K2,V> replaceBy(final Entry<K1,Map<K2,V>> replacement) {
        return new Level1MapOfMapSelectedEntriesSelectedOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
    ...
    public Level2MapOfMapSelectedEntriesSelectedKeyOperator<K1,K2,V> onKey() {
        return new Level2MapOfMapSelectedEntriesSelectedKeyOperatorImpl<K1,K2,V>(getTarget().iterateIndex(0));
    }


    public Level2MapOfMapSelectedEntriesSelectedValueOperator<K1,K2,V> onValue() {
        return new Level2MapOfMapSelectedEntriesSelectedValueOperatorImpl<K1,K2,V>(getTarget().iterateIndex(1));
    }
