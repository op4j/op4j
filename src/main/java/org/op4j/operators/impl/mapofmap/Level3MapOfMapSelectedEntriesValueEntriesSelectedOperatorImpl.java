...
public class Level3MapOfMapSelectedEntriesValueEntriesSelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level3MapOfMapSelectedEntriesValueEntriesSelectedOperator<K1,K2,V> {
    ...
    public Level3MapOfMapSelectedEntriesValueEntriesSelectedOperator<K1,K2,V> replaceBy(final Entry<K2,V> replacement) {
        return new Level3MapOfMapSelectedEntriesValueEntriesSelectedOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
