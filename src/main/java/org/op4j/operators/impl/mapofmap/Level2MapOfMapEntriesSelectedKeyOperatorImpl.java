...
public class Level2MapOfMapEntriesSelectedKeyOperatorImpl<K1,K2,V,I> extends AbstractOperatorImpl implements Level2MapOfMapEntriesSelectedKeyOperator<K1,K2,V,I> {
    ...
    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifIndex(final int... indices) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectIndex(indices));
    }


    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifTrue(final IEvaluator<Boolean, ? super K1> eval) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectMatching(eval));
    }


    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifFalse(final IEvaluator<Boolean, ? super K1> eval) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectNotMatching(eval));
    }


    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifNullOrFalse(final IEvaluator<Boolean, ? super K1> eval) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectNullOrNotMatching(eval));
    }
    ...
    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifNotNullAndFalse(final IEvaluator<Boolean, ? super K1> eval) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectNotNullAndNotMatching(eval));
    }


    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifNull() {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectNull());
    }


    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifNullOrTrue(final IEvaluator<Boolean, ? super K1> eval) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectNullOrMatching(eval));
    }


    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifIndexNot(final int... indices) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectIndexNot(indices));
    }


    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifNotNull() {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectNotNull());
    }
    ...
    public Level2MapOfMapEntriesSelectedKeySelectedOperator<K1,K2,V,I> ifNotNullAndTrue(final IEvaluator<Boolean, ? super K1> eval) {
        return new Level2MapOfMapEntriesSelectedKeySelectedOperatorImpl<K1,K2,V,I>(getTarget().selectNotNullAndMatching(eval));
    }


    public Level2MapOfMapEntriesSelectedKeyOperator<K1,K2,V,I> eval(final IEvaluator<? extends K1,? super K1> eval) {
        return new Level2MapOfMapEntriesSelectedKeyOperatorImpl<K1,K2,V,I>(getTarget().execute(eval, Normalization.NONE));
    }
    ...
    public Level2MapOfMapEntriesSelectedKeyOperator<K1,K2,V,I> exec(final IFunction<? extends K1,? super K1> function) {
        return new Level2MapOfMapEntriesSelectedKeyOperatorImpl<K1,K2,V,I>(getTarget().execute(function, Normalization.NONE));
    }


    public Level2MapOfMapEntriesSelectedKeyOperator<K1,K2,V,I> replaceWith(final K1 replacement) {
        return new Level2MapOfMapEntriesSelectedKeyOperatorImpl<K1,K2,V,I>(getTarget().replaceWith(replacement));
    }


    public Level2MapOfMapEntriesSelectedKeyOperator<K1,K2,V,I> convert(final IConverter<? extends K1,? super K1> converter) {
        return new Level2MapOfMapEntriesSelectedKeyOperatorImpl<K1,K2,V,I>(getTarget().execute(converter, Normalization.NONE));
    }
