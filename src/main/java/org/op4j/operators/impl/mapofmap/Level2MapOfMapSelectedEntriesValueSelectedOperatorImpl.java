...
public final class Level2MapOfMapSelectedEntriesValueSelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level2MapOfMapSelectedEntriesValueSelectedOperator<K1,K2,V> {
    ...
    public Level2MapOfMapSelectedEntriesValueSelectedOperator<K1,K2,V> removeAllTrue(final IFunction<Boolean,? super Entry<K2,V>> eval) {
    ...
    public Level2MapOfMapSelectedEntriesValueSelectedOperator<K1,K2,V> removeAllFalse(final IFunction<Boolean,? super Entry<K2,V>> eval) {
    ...
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V> forEachEntry() {
        return new Level3MapOfMapSelectedEntriesValueSelectedEntriesOperatorImpl<K1,K2,V>(getTarget().iterate(Structure.MAP));
    }
    ...
    public Level2MapOfMapSelectedEntriesValueSelectedOperator<K1,K2,V> execIfNotNullAsMap(final IFunction<? extends Map<? extends K2,? extends V>,? super Map<K2,V>> function) {
        return new Level2MapOfMapSelectedEntriesValueSelectedOperatorImpl<K1,K2,V>(getTarget().executeIfNotNull(function, Normalisation.MAP));
    }


    public Level2MapOfMapSelectedEntriesValueSelectedOperator<K1,K2,V> execAsMap(final IFunction<? extends Map<? extends K2,? extends V>,? super Map<K2,V>> function) {
        return new Level2MapOfMapSelectedEntriesValueSelectedOperatorImpl<K1,K2,V>(getTarget().execute(function, Normalisation.MAP));
    }
    ...
    public Level2MapOfMapSelectedEntriesValueSelectedOperator<K1,K2,V> replaceWith(final Map<K2,V> replacement) {
        return new Level2MapOfMapSelectedEntriesValueSelectedOperatorImpl<K1,K2,V>(getTarget().replaceWith(replacement, Normalisation.MAP));
    }
