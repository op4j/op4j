...
public final class Level4MapOfMapSelectedEntriesSelectedValueSelectedEntriesValueSelectedOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level4MapOfMapSelectedEntriesSelectedValueSelectedEntriesValueSelectedOperator<K1,K2,V> {
    ...
    public Level4MapOfMapSelectedEntriesSelectedValueSelectedEntriesValueSelectedOperator<K1,K2,V> execIfNotNull(final IFunction<? extends V,? super V> function) {
        return new Level4MapOfMapSelectedEntriesSelectedValueSelectedEntriesValueSelectedOperatorImpl<K1,K2,V>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
