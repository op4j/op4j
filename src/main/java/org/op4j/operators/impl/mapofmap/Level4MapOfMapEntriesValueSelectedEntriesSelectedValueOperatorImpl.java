...
public class Level4MapOfMapEntriesValueSelectedEntriesSelectedValueOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level4MapOfMapEntriesValueSelectedEntriesSelectedValueOperator<K1,K2,V> {
    ...
    public Level4MapOfMapEntriesValueSelectedEntriesSelectedValueOperator<K1,K2,V> replaceBy(final V replacement) {
        return new Level4MapOfMapEntriesValueSelectedEntriesSelectedValueOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
