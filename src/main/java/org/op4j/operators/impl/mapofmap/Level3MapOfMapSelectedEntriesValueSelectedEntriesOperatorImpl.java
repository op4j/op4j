...
public class Level3MapOfMapSelectedEntriesValueSelectedEntriesOperatorImpl<K1,K2,V> extends AbstractOperatorImpl implements Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V> {
    ...
    public Level3MapOfMapSelectedEntriesValueSelectedEntriesOperator<K1,K2,V> replaceBy(final Entry<K2,V> replacement) {
        return new Level3MapOfMapSelectedEntriesValueSelectedEntriesOperatorImpl<K1,K2,V>(getTarget().replaceBy(replacement));
    }
