 ...
 *
 */
public final class Level1ListOfMapElementsOperatorImpl<K,V> extends AbstractOperatorImpl
    ...
    public Level1ListOfMapElementsOperator<K, V> removeAllTrue(final IFunction<Boolean, ? super Entry<K, V>> eval) {
        return new Level1ListOfMapElementsOperatorImpl<K, V>(getTarget().execute(new MapFuncs.RemoveAllTrue<K, V>(eval)));
    }

    public Level1ListOfMapElementsOperator<K, V> removeAllFalse(final IFunction<Boolean, ? super Entry<K, V>> eval) {
    ...
    public Level1ListOfMapElementsSelectedOperator<K, V> ifIndex(final int... indexes) {
        return new Level1ListOfMapElementsSelectedOperatorImpl<K, V>(getTarget().selectIndex(indexes));
    }


    public Level1ListOfMapElementsSelectedOperator<K, V> ifIndexNot(final int... indexes) {
        return new Level1ListOfMapElementsSelectedOperatorImpl<K, V>(getTarget().selectIndexNot(indexes));
    }


    public Level1ListOfMapElementsSelectedOperator<K, V> ifTrue(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level1ListOfMapElementsSelectedOperatorImpl<K, V>(getTarget().selectMatching(eval));
    }


    public Level1ListOfMapElementsSelectedOperator<K, V> ifFalse(final IFunction<Boolean, ? super Map<K, V>> eval) {
    ...
    public Level1ListOfMapElementsSelectedOperator<K, V> ifNotNullAndTrue(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level1ListOfMapElementsSelectedOperatorImpl<K, V>(getTarget().selectNotNullAndMatching(eval));
    }


    public Level1ListOfMapElementsSelectedOperator<K, V> ifNotNullAndFalse(final IFunction<Boolean, ? super Map<K, V>> eval) {
    ...
    public Level1ListOfMapElementsSelectedOperator<K, V> ifNullOrTrue(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level1ListOfMapElementsSelectedOperatorImpl<K, V>(getTarget().selectNullOrMatching(eval));
    }


    public Level1ListOfMapElementsSelectedOperator<K, V> ifNullOrFalse(final IFunction<Boolean, ? super Map<K, V>> eval) {
        return new Level1ListOfMapElementsSelectedOperatorImpl<K, V>(getTarget().selectNullOrNotMatching(eval));
    }


    public <X, Y> Level1ListOfMapElementsOperator<X, Y> execIfNotNullAsMap(final IFunction<? extends Map<X, Y>, ? super Map<K, V>> function) {
        return new Level1ListOfMapElementsOperatorImpl<X, Y>(getTarget().executeIfNotNull(function, Normalisation.MAP));
    }
    ...
    public <X> Level1ListElementsOperator<X> execIfNotNull(final IFunction<X, ? super Map<K, V>> function) {
