...
public class Level1ListOfMapElementsOperator<K,V> extends Operator
    ...
    public ILevel1ListOfMapElementsOperator<K, V> put(final int position, final K newKey, final V newValue) {
        return new Level1ListOfMapElementsOperator<K, V>(getTarget().execute(MapFunc.put(position, newKey, newValue)));
    }
    ...
    public ILevel1ListOfMapElementsOperator<K, V> putAll(final int position, final Map<K, V> map) {
        return new Level1ListOfMapElementsOperator<K, V>(getTarget().execute(MapFunc.putAll(position, map)));
    }
