...
public class Level3ListOfMapSelectedElementsEntriesKeyOperatorImpl<K,V> extends AbstractOperatorImpl implements Level3ListOfMapSelectedElementsEntriesKeyOperator<K,V> {
    ...
    public Level3ListOfMapSelectedElementsEntriesKeyOperator<K,V> replaceBy(final K replacement) {
        return new Level3ListOfMapSelectedElementsEntriesKeyOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
