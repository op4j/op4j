...
public class Level3ListOfMapElementsEntriesValueOperator<K,V> extends Operator
    ...
    public ILevel3ListOfMapElementsEntriesValueOperator<K, Number> callForNumber(final String methodName, final Object... optionalParameters) {
        return new Level3ListOfMapElementsEntriesValueOperator<K, Number>(getTarget().execute(Call.forNumber(methodName, optionalParameters)));
    }
    ...
    public ILevel3ListOfMapElementsEntriesValueOperator<K, Number> evalForNumber(final String evalExpression, final Object... parameters) {
        return new Level3ListOfMapElementsEntriesValueOperator<K, Number>(getTarget().execute(Eval.forNumber(evalExpression, parameters)));
    }
