...
public class Level3ListOfMapElementsSelectedEntriesKeySelectedOperatorImpl<K,V> extends AbstractOperatorImpl implements Level3ListOfMapElementsSelectedEntriesKeySelectedOperator<K,V> {
    ...
    public Level3ListOfMapElementsSelectedEntriesKeySelectedOperator<K,V> replaceBy(final K replacement) {
        return new Level3ListOfMapElementsSelectedEntriesKeySelectedOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
