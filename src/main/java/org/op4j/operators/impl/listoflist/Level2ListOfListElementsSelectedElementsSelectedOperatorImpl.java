...
public class Level2ListOfListElementsSelectedElementsSelectedOperatorImpl<T> extends AbstractOperatorImpl implements Level2ListOfListElementsSelectedElementsSelectedOperator<T> {
    ...
    public Level2ListOfListElementsSelectedElementsSelectedOperator<T> replaceBy(final T replacement) {
        return new Level2ListOfListElementsSelectedElementsSelectedOperatorImpl<T>(getTarget().replaceBy(replacement));
    }
