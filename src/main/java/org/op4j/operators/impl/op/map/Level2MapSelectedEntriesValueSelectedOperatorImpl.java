...
public final class Level2MapSelectedEntriesValueSelectedOperatorImpl<K,V,I> extends AbstractOperatorImpl implements UniqOpOperator<Map<K,V>,I>, Level2MapSelectedEntriesValueSelectedOperator<K,V,I> {
