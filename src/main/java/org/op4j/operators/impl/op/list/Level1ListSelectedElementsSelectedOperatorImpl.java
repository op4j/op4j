...
public final class Level1ListSelectedElementsSelectedOperatorImpl<T,I> extends AbstractOperatorImpl implements UniqOpOperator<List<T>>, Level1ListSelectedElementsSelectedOperator<T,I> {
