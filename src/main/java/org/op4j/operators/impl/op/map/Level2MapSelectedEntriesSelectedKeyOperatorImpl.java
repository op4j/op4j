...
public final class Level2MapSelectedEntriesSelectedKeyOperatorImpl<K,V,I> extends AbstractOperatorImpl implements UniqOpOperator<Map<K,V>,I>, Level2MapSelectedEntriesSelectedKeyOperator<K,V,I> {
