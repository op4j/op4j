...
public final class Level2MapEntriesSelectedKeySelectedOperator<I,K,V> extends AbstractOperator implements UniqOpOperator<I,Map<K,V>>, ILevel2MapEntriesSelectedKeySelectedOperator<I,K,V> {
    ...
    public Level2MapEntriesSelectedKeySelectedOperator<I,K,V> execIfNotNull(final IFunction<? super K,? extends K> function) {
        return new Level2MapEntriesSelectedKeySelectedOperator<I,K,V>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
