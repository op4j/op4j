...
public final class Level1ListSelectedElementsOperatorImpl<I,T> extends AbstractOperatorImpl implements UniqOpOperator<I,List<T>>, Level1ListSelectedElementsOperator<I,T> {
