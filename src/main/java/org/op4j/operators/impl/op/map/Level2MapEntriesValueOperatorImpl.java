...
public final class Level2MapEntriesValueOperatorImpl<K,V,I> extends AbstractOperatorImpl
        implements UniqOpOperator<Map<K,V>,I>, Level2MapEntriesValueOperator<K,V,I> {
    ...
    public Level1MapEntriesOperatorImpl<K, V,I> endOn() {
        return new Level1MapEntriesOperatorImpl<K, V,I>(getTarget().endOn());
    }


    public <X> Level2MapEntriesValueOperatorImpl<K, X,I> asType(final Type<X> type) {
        return new Level2MapEntriesValueOperatorImpl<K, X,I>(getTarget().cast(CastType.OBJECT, type));
    }

    public Level2MapEntriesValueOperatorImpl<K, ?,I> asUnknown() {
    ...
    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifIndex(final int... indexes) {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectIndex(indexes));
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifIndexNot(final int... indexes) {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectIndexNot(indexes));
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifTrue(final IFunction<Boolean, ? super V> eval) {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectMatching(eval));
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifFalse(final IFunction<Boolean, ? super V> eval) {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectNotMatching(eval));
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifNotNull() {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectNotNull());
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifNotNullAndTrue(final IFunction<Boolean, ? super V> eval) {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectNotNullAndMatching(eval));
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifNotNullAndFalse(final IFunction<Boolean, ? super V> eval) {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectNotNullAndNotMatching(eval));
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifNull() {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectNull());
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifNullOrTrue(final IFunction<Boolean, ? super V> eval) {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectNullOrMatching(eval));
    }


    public Level2MapEntriesValueSelectedOperatorImpl<K, V,I> ifNullOrFalse(final IFunction<Boolean, ? super V> eval) {
        return new Level2MapEntriesValueSelectedOperatorImpl<K, V,I>(getTarget().selectNullOrNotMatching(eval));
    }


    public <X> Level2MapEntriesValueOperatorImpl<K, X,I> execIfNotNull(final IFunction<X, ? super V> function) {
        return new Level2MapEntriesValueOperatorImpl<K, X,I>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }


    public <X> Level2MapEntriesValueOperatorImpl<K, X,I> exec(final IFunction<X, ? super V> function) {
        return new Level2MapEntriesValueOperatorImpl<K, X,I>(getTarget().execute(function, Normalisation.NONE));
    }


    public Level2MapEntriesValueOperatorImpl<K, V,I> replaceWith(final V replacement) {
        return new Level2MapEntriesValueOperatorImpl<K, V,I>(getTarget().replaceWith(replacement, Normalisation.NONE));
    }


    public Level2MapEntriesValueOperatorImpl<K, V,I> replaceIfNullWith(final V replacement) {
