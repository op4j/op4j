...
import org.op4j.operators.intf.map.ILevel2MapSelectedEntriesKeySelectedOperator;
...
public final class Level2MapSelectedEntriesKeySelectedOperator<I,K,V> extends AbstractOperator implements UniqOpOperator<I,Map<K,V>>, ILevel2MapSelectedEntriesKeySelectedOperator<I,K,V> {
    ...
    public Level2MapSelectedEntriesKeySelectedOperator<I,K,V> execIfNotNull(final IFunction<? super K,? extends K> function) {
        return new Level2MapSelectedEntriesKeySelectedOperator<I,K,V>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
