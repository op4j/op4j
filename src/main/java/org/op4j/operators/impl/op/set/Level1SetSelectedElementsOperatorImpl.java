...
public final class Level1SetSelectedElementsOperatorImpl<I,T> extends AbstractOperatorImpl implements UniqOpOperator<I,Set<T>>, Level1SetSelectedElementsOperator<I,T> {
