...
public final class Level1MapSelectedEntriesSelectedOperatorImpl<K,V,I> extends AbstractOperatorImpl implements UniqOpOperator<Map<K,V>,I>, Level1MapSelectedEntriesSelectedOperator<K,V,I> {
