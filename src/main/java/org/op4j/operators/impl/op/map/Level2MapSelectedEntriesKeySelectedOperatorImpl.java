...
public final class Level2MapSelectedEntriesKeySelectedOperatorImpl<K,V,I> extends AbstractOperatorImpl implements UniqOpOperator<Map<K,V>,I>, Level2MapSelectedEntriesKeySelectedOperator<K,V,I> {
