...
public final class Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V> extends AbstractOperator implements UniqOpOperator<I,Map<K,V>>, ILevel2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V> {
    ...
    public Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V> execIfNotNull(final IFunction<? super V,? extends V> function) {
        return new Level2MapSelectedEntriesSelectedValueSelectedOperator<I,K,V>(getTarget().executeIfNotNull(function, Normalisation.NONE));
    }
