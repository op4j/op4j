...
public final class Level2MapEntriesSelectedValueSelectedOperatorImpl<I,K,V> extends AbstractOperatorImpl implements UniqOpOperator<I,Map<K,V>>, Level2MapEntriesSelectedValueSelectedOperator<I,K,V> {
    ...
    public Level2MapEntriesSelectedValueSelectedOperatorImpl<I,K,V> execIfNotNull(final IFunction<? extends V,? super V> function) {
    ...
    public Level2MapEntriesSelectedValueSelectedOperatorImpl<I,K,V> exec(final IFunction<? extends V,? super V> function) {
