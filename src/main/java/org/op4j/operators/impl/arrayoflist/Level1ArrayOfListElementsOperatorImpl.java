 ...
 *
 */
public final class Level1ArrayOfListElementsOperatorImpl<T> extends AbstractOperatorImpl
    ...
    public Level0ArrayOfListOperator<T> endFor() {
        return new Level0ArrayOfListOperatorImpl<T>(getTarget().endIterate(List.class));
    }


    public Level2ArrayOfListElementsElementsOperator<T> forEach() {
        return new Level2ArrayOfListElementsElementsOperatorImpl<T>(getTarget().iterate(Structure.LIST));
    }


    public Level1ArrayOfListElementsOperator<T> removeAllIndexes(final int... indexes) {
        return new Level1ArrayOfListElementsOperatorImpl<T>(getTarget().execute(new ListFuncs.RemoveAllIndexes<T>(indexes)));
    }
    ...
    public Level1ArrayOfListElementsOperator<T> removeAllIndexesNot(final int... indexes) {
        return new Level1ArrayOfListElementsOperatorImpl<T>(getTarget().execute(new ListFuncs.RemoveAllIndexesNot<T>(indexes)));
    }
    ...
    public Level1ArrayOfListElementsSelectedOperator<T> ifIndex(final int... indexes) {
        return new Level1ArrayOfListElementsSelectedOperatorImpl<T>(getTarget().selectIndex(indexes));
    }


    public Level1ArrayOfListElementsSelectedOperator<T> ifIndexNot(final int... indexes) {
        return new Level1ArrayOfListElementsSelectedOperatorImpl<T>(getTarget().selectIndexNot(indexes));
    }
    ...
    public <X> Level1ArrayOfListElementsOperator<X> convertAsList(final IConverter<? extends List<X>, ? super List<T>> converter) {
        return new Level1ArrayOfListElementsOperatorImpl<X>(getTarget().execute(converter, Normalisation.LIST));
    }


    public <X> Level1ArrayOfListElementsOperator<X> evalAsList(final IEvaluator<? extends List<X>, ? super List<T>> eval) {
        return new Level1ArrayOfListElementsOperatorImpl<X>(getTarget().execute(eval, Normalisation.LIST));
    }


    public <X> Level1ArrayOfListElementsOperator<X> execAsList(final IFunction<? extends List<X>, ? super List<T>> function) {
        return new Level1ArrayOfListElementsOperatorImpl<X>(getTarget().execute(function, Normalisation.LIST));
    }
