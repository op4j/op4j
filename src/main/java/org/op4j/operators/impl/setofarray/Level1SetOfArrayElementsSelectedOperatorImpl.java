...
public final class Level1SetOfArrayElementsSelectedOperatorImpl<T> extends AbstractOperatorImpl implements Level1SetOfArrayElementsSelectedOperator<T> {
    ...
    public Level1SetOfArrayElementsSelectedOperator<T> removeAllTrue(final IFunction<Boolean,? super T> eval) {
    ...
    public Level1SetOfArrayElementsSelectedOperator<T> removeAllFalse(final IFunction<Boolean,? super T> eval) {
    ...
    public Level1SetOfArrayElementsSelectedOperator<T> removeAllNullOrFalse(final IFunction<Boolean,? super T> eval) {
    ...
    public Level1SetOfArrayElementsSelectedOperator<T> removeAllNotNullAndFalse(final IFunction<Boolean,? super T> eval) {
    ...
    public Level1SetOfArrayElementsSelectedOperator<T> removeAllNotNullAndTrue(final IFunction<Boolean,? super T> eval) {
    ...
    public Level1SetOfArrayElementsSelectedOperator<T> removeAllNullOrTrue(final IFunction<Boolean,? super T> eval) {
    ...
    public Level1SetOfArrayElementsSelectedOperator<T> execIfNotNullAsArray(final IFunction<? extends T[],? super T[]> function) {
        return new Level1SetOfArrayElementsSelectedOperatorImpl<T>(this.type, getTarget().executeIfNotNull(function, Normalisation.ARRAY(this.type.getRawClass())));
    }


    public Level1SetOfArrayElementsSelectedOperator<T> execAsArray(final IFunction<? extends T[],? super T[]> function) {
        return new Level1SetOfArrayElementsSelectedOperatorImpl<T>(this.type, getTarget().execute(function, Normalisation.ARRAY(this.type.getRawClass())));
    }
    ...
    public Level1SetOfArrayElementsSelectedOperator<T> map(final IFunction<? extends T,? super T> function) {
        return new Level1SetOfArrayElementsSelectedOperatorImpl<T>(this.type, getTarget().map(Structure.ARRAY, function, this.type.getRawClass()));
    }


    public Level1SetOfArrayElementsSelectedOperator<T> replaceWith(final T[] replacement) {
        return new Level1SetOfArrayElementsSelectedOperatorImpl<T>(this.type, getTarget().replaceWith(replacement, Normalisation.ARRAY(this.type.getRawClass())));
    }
