...
public class Level2MapEntriesSelectedKeyOperatorImpl<K,V> extends AbstractOperatorImpl implements Level2MapEntriesSelectedKeyOperator<K,V> {
    ...
    public Level2MapEntriesSelectedKeyOperator<K,V> replaceBy(final K replacement) {
        return new Level2MapEntriesSelectedKeyOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
