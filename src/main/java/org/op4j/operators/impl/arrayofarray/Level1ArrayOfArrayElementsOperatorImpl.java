 ...
 *
 */
public final class Level1ArrayOfArrayElementsOperatorImpl<T> extends AbstractOperatorImpl
    ...
    public Level1ArrayOfArrayElementsOperator<T> removeAllTrue(final IFunction<Boolean, ? super T> eval) {
        return new Level1ArrayOfArrayElementsOperatorImpl<T>(this.type, getTarget().execute(new ArrayFuncs.RemoveAllTrue<T>(eval)));
    }

    public Level1ArrayOfArrayElementsOperator<T> removeAllFalse(final IFunction<Boolean, ? super T> eval) {
        return new Level1ArrayOfArrayElementsOperatorImpl<T>(this.type, getTarget().execute(new ArrayFuncs.RemoveAllFalse<T>(eval)));
    }

    public Level1ArrayOfArrayElementsOperator<T> removeAllNullOrFalse(final IFunction<Boolean, ? super T> eval) {
    ...
    public Level1ArrayOfArrayElementsOperator<T> removeAllNotNullAndFalse(final IFunction<Boolean, ? super T> eval) {
    ...
    public Level1ArrayOfArrayElementsOperator<T> removeAllNullOrTrue(final IFunction<Boolean, ? super T> eval) {
    ...
    public Level1ArrayOfArrayElementsOperator<T> removeAllNotNullAndTrue(final IFunction<Boolean, ? super T> eval) {
    ...
    public Level1ArrayOfArrayElementsSelectedOperator<T> ifTrue(final IFunction<Boolean, ? super T[]> eval) {
        return new Level1ArrayOfArrayElementsSelectedOperatorImpl<T>(this.type, getTarget().selectMatching(eval));
    }


    public Level1ArrayOfArrayElementsSelectedOperator<T> ifFalse(final IFunction<Boolean, ? super T[]> eval) {
    ...
    public Level1ArrayOfArrayElementsSelectedOperator<T> ifNotNullAndTrue(final IFunction<Boolean, ? super T[]> eval) {
        return new Level1ArrayOfArrayElementsSelectedOperatorImpl<T>(this.type, getTarget().selectNotNullAndMatching(eval));
    }


    public Level1ArrayOfArrayElementsSelectedOperator<T> ifNotNullAndFalse(final IFunction<Boolean, ? super T[]> eval) {
    ...
    public Level1ArrayOfArrayElementsSelectedOperator<T> ifNullOrTrue(final IFunction<Boolean, ? super T[]> eval) {
        return new Level1ArrayOfArrayElementsSelectedOperatorImpl<T>(this.type, getTarget().selectNullOrMatching(eval));
    }


    public Level1ArrayOfArrayElementsSelectedOperator<T> ifNullOrFalse(final IFunction<Boolean, ? super T[]> eval) {
        return new Level1ArrayOfArrayElementsSelectedOperatorImpl<T>(this.type, getTarget().selectNullOrNotMatching(eval));
    }


	public Level1ArrayOfArrayElementsOperator<T> execIfNotNullAsArray(final IFunction<? extends T[], ? super T[]> function) {
        return new Level1ArrayOfArrayElementsOperatorImpl<T>(this.type, getTarget().executeIfNotNull(function, Normalisation.ARRAY(this.type.getRawClass())));
    }
    ...
    public <X> Level1ArrayOfArrayElementsOperator<X> execIfNotNullAsArrayOf(final Type<X> newType, final IFunction<X[], ? super T[]> function) {
        return new Level1ArrayOfArrayElementsOperatorImpl<X>(newType, getTarget().executeIfNotNull(function, Normalisation.ARRAY(newType.getRawClass())));
    }
    ...
    public Level1ArrayOfArrayElementsOperator<T> replaceWith(final T[] replacement) {
        return new Level1ArrayOfArrayElementsOperatorImpl<T>(this.type, getTarget().replaceWith(replacement, Normalisation.ARRAY(this.type.getRawClass())));
    }
    ...
    public <X> Level1ArrayOfArrayElementsOperator<X> map(final Type<X> newType, final IFunction<X, ? super T> function) {
        return new Level1ArrayOfArrayElementsOperatorImpl<X>(newType, getTarget().map(Structure.ARRAY, function, newType.getRawClass()));
    }


    public Level1ArrayOfArrayElementsOperator<T> map(final IFunction<? extends T, ? super T> function) {
        return new Level1ArrayOfArrayElementsOperatorImpl<T>(this.type, getTarget().map(Structure.ARRAY, function, this.type.getRawClass()));
    }
