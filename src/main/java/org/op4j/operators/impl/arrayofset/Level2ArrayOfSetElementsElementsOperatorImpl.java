 ...
 *
 */
public final class Level2ArrayOfSetElementsElementsOperatorImpl<T> extends AbstractOperatorImpl
    ...
    public Level1ArrayOfSetElementsOperator<T> endFor() {
        return new Level1ArrayOfSetElementsOperatorImpl<T>(getTarget().endIterate(null));
    }
    ...
    public <X> Level2ArrayOfSetElementsElementsOperator<X> exec(final IFunction<X, ? super T> function) {
        return new Level2ArrayOfSetElementsElementsOperatorImpl<X>(getTarget().execute(function, Normalisation.NONE));
    }


    public Level2ArrayOfSetElementsElementsOperator<T> replaceWith(final T replacement) {
        return new Level2ArrayOfSetElementsElementsOperatorImpl<T>(getTarget().replaceWith(replacement, Normalisation.NONE));
    }
