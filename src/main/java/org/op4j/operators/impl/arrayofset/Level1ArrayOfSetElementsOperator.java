...
public class Level1ArrayOfSetElementsOperator<T> extends Operator
    ...
    public ILevel2ArrayOfSetElementsElementsOperator<T> forEachIndex(final int... indices) {
        return new Level2ArrayOfSetElementsElementsOperator<T>(getTarget().iterate(indices));
    }
    ...
    public ILevel2ArrayOfSetElementsElementsOperator<T> forEachMatching(final String expression, final Object... optionalExpParams) {
        return new Level2ArrayOfSetElementsElementsOperator<T>(getTarget().iterate(Eval.booleanExp(expression, VarArgsUtil.asOptionalObjectList(optionalExpParams))));
    }
    ...
    public ILevel2ArrayOfSetElementsElementsOperator<T> forEachNullOrMatching(final IEval<Boolean, ? super T> eval) {
        return new Level2ArrayOfSetElementsElementsOperator<T>(getTarget().iterateNullOr(eval));
    }
    ...
    public ILevel2ArrayOfSetElementsElementsOperator<T> forEachIndexNot(final int... indices) {
        return new Level2ArrayOfSetElementsElementsOperator<T>(getTarget().iterateNot(indices));
    }
    ...
    public ILevel2ArrayOfSetElementsElementsOperator<T> forEachNotNullMatching(final String expression, final Object... optionalExpParams) {
        return new Level2ArrayOfSetElementsElementsOperator<T>(getTarget().iterateNotNullAnd(Eval.booleanExp(expression, VarArgsUtil.asOptionalObjectList(optionalExpParams))));
    }
    ...
    public ILevel2ArrayOfSetElementsElementsOperator<T> forEachNullOrMatching(final String expression, final Object... optionalExpParams) {
        return new Level2ArrayOfSetElementsElementsOperator<T>(getTarget().iterateNullOr(Eval.booleanExp(expression, VarArgsUtil.asOptionalObjectList(optionalExpParams))));
    }
    ...
    public ILevel1ArrayOfSetElementsOperator<T> removeIndexes(final int... indices) {
        return new Level1ArrayOfSetElementsOperator<T>(getTarget().execute(new SetFunc.RemoveIndexes<T>(indices)));
    }


    public ILevel1ArrayOfSetElementsOperator<T> removeEquals(final T... values) {
        return new Level1ArrayOfSetElementsOperator<T>(getTarget().execute(new SetFunc.RemoveEquals<T>(values)));
    }
    ...
    public ILevel1ArrayOfSetElementsOperator<T> removeMatching(final IEval<Boolean, ? super T> eval) {
        return new Level1ArrayOfSetElementsOperator<T>(getTarget().execute(new SetFunc.RemoveMatching<T>(eval)));
    }


    public ILevel1ArrayOfSetElementsOperator<T> removeNullOrMatching(final IEval<Boolean, ? super T> eval) {
        return new Level1ArrayOfSetElementsOperator<T>(getTarget().execute(new SetFunc.RemoveNullOrMatching<T>(eval)));
    }


    public ILevel1ArrayOfSetElementsOperator<T> removeNotNullMatching(final IEval<Boolean, ? super T> eval) {
        return new Level1ArrayOfSetElementsOperator<T>(getTarget().execute(new SetFunc.RemoveNotNullMatching<T>(eval)));
    }
    ...
    public ILevel1ArrayOfSetElementsOperator<T> removeIndexesNot(final int... indices) {
        return new Level1ArrayOfSetElementsOperator<T>(getTarget().execute(new SetFunc.RemoveIndexesNot<T>(indices)));
    }


    public ILevel1ArrayOfSetElementsOperator<T> removeNotNullMatching(final String expression, final Object... optionalExpParams) {
        return new Level1ArrayOfSetElementsOperator<T>(getTarget().execute(new SetFunc.RemoveNotNullMatching<T>(Eval.booleanExp(expression, optionalExpParams))));
    }


    public ILevel1ArrayOfSetElementsOperator<T> removeNullOrMatching(final String expression, final Object... optionalExpParams) {
        return new Level1ArrayOfSetElementsOperator<T>(getTarget().execute(new SetFunc.RemoveNullOrMatching<T>(Eval.booleanExp(expression, optionalExpParams))));
    }
