...
public class Level1ArrayOfSetSelectedElementsOperatorImpl<T> extends AbstractOperatorImpl implements Level1ArrayOfSetSelectedElementsOperator<T> {
    ...
    public Level1ArrayOfSetSelectedElementsOperator<T> removeAllIndexes(final int... indices) {
        return new Level1ArrayOfSetSelectedElementsOperatorImpl<T>(getTarget().execute(new SetFuncs.RemoveAllIndexes<T>(indices)));
    }
    ...
    public Level1ArrayOfSetSelectedElementsOperator<T> removeAllIndexesNot(final int... indices) {
        return new Level1ArrayOfSetSelectedElementsOperatorImpl<T>(getTarget().execute(new SetFuncs.RemoveAllIndexesNot<T>(indices)));
    }
    ...
    public Level1ArrayOfSetSelectedElementsOperator<T> replaceBy(final Set<T> replacement) {
        return new Level1ArrayOfSetSelectedElementsOperatorImpl<T>(getTarget().replaceBy(replacement));
    }


    public Level1ArrayOfSetSelectedElementsOperator<T> eval(final IEvaluator<? extends Set<? extends T>,? super Set<T>> eval) {
        return new Level1ArrayOfSetSelectedElementsOperatorImpl<T>(getTarget().execute(eval, Normalization.SET));
    }
    ...
    public Level1ArrayOfSetSelectedElementsOperator<T> exec(final IFunction<? extends Set<? extends T>,? super Set<T>> function) {
        return new Level1ArrayOfSetSelectedElementsOperatorImpl<T>(getTarget().execute(function, Normalization.SET));
    }
    ...
    public Level1ArrayOfSetSelectedElementsOperator<T> convert(final IConverter<? extends Set<? extends T>,? super Set<T>> converter) {
        return new Level1ArrayOfSetSelectedElementsOperatorImpl<T>(getTarget().execute(converter, Normalization.SET));
    }
