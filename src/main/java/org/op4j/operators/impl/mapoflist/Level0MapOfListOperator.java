...
public class Level0MapOfListOperator<K,V> extends Operator
    ...
    public ILevel0MapOfListOperator<K, V> extractAll(final ISelect<Entry<K, List<V>>> selector) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    public ILevel0MapOfListOperator<K, V> extractAllBut(final ISelect<Entry<K, List<V>>> selector) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    public ILevel0MapOfListOperator<K, V> removeAllExceptKeys(final K... keys) {
        return new Level0MapOfListOperator<K, V>(getTarget().execute(new MapFunc.RemoveAllExceptKeys<K, List<V>>(keys)));
    }
