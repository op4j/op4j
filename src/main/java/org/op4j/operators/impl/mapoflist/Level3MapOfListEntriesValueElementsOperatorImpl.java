 ...
 *
 */
public class Level3MapOfListEntriesValueElementsOperatorImpl<K,V,I> extends AbstractOperatorImpl
        implements Level3MapOfListEntriesValueElementsOperator<K,V,I> {
    ...
    public Level2MapOfListEntriesValueOperator<K, V,I> endFor() {
        return new Level2MapOfListEntriesValueOperatorImpl<K, V,I>(getTarget().endIterate(Structure.LIST, null));
    }
    ...
    public <X> Level3MapOfListEntriesValueElementsOperator<K, X,I> asType(final Type<X> type) {
        ...
        return new Level3MapOfListEntriesValueElementsOperatorImpl<K, X,I>(getTarget());
    }
    ...
    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifIndex(final int... indices) {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectIndex(indices));
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifIndexNot(final int... indices) {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectIndexNot(indices));
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifTrue(final IEvaluator<Boolean, ? super V> eval) {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectMatching(eval));
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifFalse(final IEvaluator<Boolean, ? super V> eval) {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectNotMatching(eval));
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifNotNull() {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectNotNull());
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifNotNullAndTrue(final IEvaluator<Boolean, ? super V> eval) {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectNotNullAndMatching(eval));
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifNotNullAndFalse(final IEvaluator<Boolean, ? super V> eval) {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectNotNullAndNotMatching(eval));
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifNull() {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectNull());
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifNullOrTrue(final IEvaluator<Boolean, ? super V> eval) {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectNullOrMatching(eval));
    }


    public Level3MapOfListEntriesValueElementsSelectedOperator<K, V,I> ifNullOrFalse(final IEvaluator<Boolean, ? super V> eval) {
        return new Level3MapOfListEntriesValueElementsSelectedOperatorImpl<K, V,I>(getTarget().selectNullOrNotMatching(eval));
    }


    public <X> Level3MapOfListEntriesValueElementsOperator<K, X,I> convert(final IConverter<X, ? super V> converter) {
        return new Level3MapOfListEntriesValueElementsOperatorImpl<K, X,I>(getTarget().execute(converter, Normalization.NONE));
    }


    public <X> Level3MapOfListEntriesValueElementsOperator<K, X,I> eval(final IEvaluator<X, ? super V> eval) {
        return new Level3MapOfListEntriesValueElementsOperatorImpl<K, X,I>(getTarget().execute(eval, Normalization.NONE));
    }


    public <X> Level3MapOfListEntriesValueElementsOperator<K, X,I> exec(final IFunction<X, ? super V> function) {
        return new Level3MapOfListEntriesValueElementsOperatorImpl<K, X,I>(getTarget().execute(function, Normalization.NONE));
    }


    public Level3MapOfListEntriesValueElementsOperator<K, V,I> replaceWith(final V replacement) {
        return new Level3MapOfListEntriesValueElementsOperatorImpl<K, V,I>(getTarget().replaceWith(replacement));
    }
