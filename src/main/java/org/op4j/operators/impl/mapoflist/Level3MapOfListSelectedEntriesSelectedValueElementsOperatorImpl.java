...
public class Level3MapOfListSelectedEntriesSelectedValueElementsOperatorImpl<K,V> extends AbstractOperatorImpl implements Level3MapOfListSelectedEntriesSelectedValueElementsOperator<K,V> {
    ...
    public Level3MapOfListSelectedEntriesSelectedValueElementsOperator<K,V> replaceBy(final V replacement) {
        return new Level3MapOfListSelectedEntriesSelectedValueElementsOperatorImpl<K,V>(getTarget().replaceBy(replacement));
    }
