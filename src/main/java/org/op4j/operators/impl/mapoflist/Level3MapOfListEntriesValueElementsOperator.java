...
public class Level3MapOfListEntriesValueElementsOperator<K,V> extends Operator
    ...
    public <X> ILevel3MapOfListEntriesValueElementsOperator<K, X> conv(final IConv<X> conv) {
        return new Level3MapOfListEntriesValueElementsOperator<K, X>(getTarget().execute(conv));
    }

    public <X> ILevel3MapOfListEntriesValueElementsOperator<K, X> convTo(final Type<X> resultType, final Object... parameters) {
        return new Level3MapOfListEntriesValueElementsOperator<K, X>(getTarget().execute(Conv.to(resultType, parameters)));
    }
    ...
    public <X> ILevel3MapOfListEntriesValueElementsOperator<K, X> of(Of<X> of) {
        // TODO Auto-generated method stub
        return null;
    }
