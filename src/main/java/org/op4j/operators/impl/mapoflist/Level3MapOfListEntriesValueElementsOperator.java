...
public class Level3MapOfListEntriesValueElementsOperator<K,V> extends Operator
    ...
    public ILevel3MapOfListEntriesValueElementsOperator<K, ?> callForObject(final String methodName, final Object... optionalParameters) {
        return new Level3MapOfListEntriesValueElementsOperator<K, Object>(getTarget().execute(Call.forObject(methodName, optionalParameters)));
    }
    ...
    public <X> ILevel3MapOfListEntriesValueElementsOperator<K, X> callForObjectOfType(final Type<X> resultType, final String methodName, final Object... optionalParameters) {
        return new Level3MapOfListEntriesValueElementsOperator<K, X>(getTarget().execute(Call.forObjectOfType(resultType, methodName, optionalParameters)));
    }
    ...
    public ILevel3MapOfListEntriesValueElementsOperator<K, ?> evalForObject(final String evalExpression, final Object... parameters) {
        return new Level3MapOfListEntriesValueElementsOperator<K, Object>(getTarget().execute(Eval.forObject(evalExpression, parameters)));
    }

    public <X> ILevel3MapOfListEntriesValueElementsOperator<K, X> evalForObjectOfType(final Type<X> resultType, final String evalExpression, final Object... parameters) {
        return new Level3MapOfListEntriesValueElementsOperator<K, X>(getTarget().execute(Eval.forObjectOfType(resultType, evalExpression, parameters)));
    }
