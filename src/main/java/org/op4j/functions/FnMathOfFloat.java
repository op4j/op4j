...
public final class FnMathOfFloat {
	...
	private final static IFunction<Iterable<Float>, Float> MAX_FUNC = new Max();
	
	private final static IFunction<Iterable<Float>, Float> MIN_FUNC = new Min();
	
	private final static IFunction<Iterable<Float>, Float> SUM_FUNC = new Sum();
	
	private final static IFunction<Iterable<Float>, Float> AVG_FUNC = new Avg();

    private final static IFunction<Float[], Float> MAX_ARRAY_FUNC = new MaxArray();
    
    private final static IFunction<Float[], Float> MIN_ARRAY_FUNC = new MinArray();
    
    private final static IFunction<Float[], Float> SUM_ARRAY_FUNC = new SumArray();
    
    private final static IFunction<Float[], Float> AVG_ARRAY_FUNC = new AvgArray();
	
	private final static IFunction<Float, Float> ABS_FUNC = new Abs();
    ...
    public final IFunction<Float[], Float> maxArray() {
        return MAX_ARRAY_FUNC;
    }

    public final IFunction<Float[], Float> minArray() {
        return MIN_ARRAY_FUNC;
    }

    public final IFunction<Float[], Float> sumArray() {
        return SUM_ARRAY_FUNC;
    }

    public final IFunction<Float[], Float> avgArray() {
        return AVG_ARRAY_FUNC;
    }

    public final IFunction<Float[], Float> avgArray(MathContext mathContext) {
        return new AvgArray(mathContext);
    }

    public final IFunction<Float[], Float> avgArray(RoundingMode roundingMode) {
    ...
    public final IFunction<Float, Float> add(byte add) {
        return add(Byte.valueOf(add));
    }

    public final IFunction<Float, Float> add(short add) {
        return add(Short.valueOf(add));
    }

    public final IFunction<Float, Float> add(int add) {
        return add(Integer.valueOf(add));
    }

    public final IFunction<Float, Float> add(long add) {
    ...
    public final IFunction<Float, Float> add(double add) {
    ...
    public final IFunction<Float, Float> subtract(byte subtract) {
        return subtract(Byte.valueOf(subtract));
    }

    public final IFunction<Float, Float> subtract(short subtract) {
        return subtract(Short.valueOf(subtract));
    }

    public final IFunction<Float, Float> subtract(int subtract) {
        return subtract(Integer.valueOf(subtract));
    }

    public final IFunction<Float, Float> subtract(long subtract) {
    ...
    public final IFunction<Float, Float> subtract(double subtract) {
    ...
    public final IFunction<Float, Float> divideBy(byte divisor) {
        return divideBy(Byte.valueOf(divisor));
    }

    public final IFunction<Float, Float> divideBy(short divisor) {
        return divideBy(Short.valueOf(divisor));
    }

    public final IFunction<Float, Float> divideBy(int divisor) {
        return divideBy(Integer.valueOf(divisor));
    }

    public final IFunction<Float, Float> divideBy(long divisor) {
    ...
    public final IFunction<Float, Float> divideBy(double divisor) {
    ...
    public final IFunction<Float, Float> divideBy(byte divisor, MathContext mathContext) {
        return divideBy(Byte.valueOf(divisor), mathContext);
    }

    public final IFunction<Float, Float> divideBy(short divisor, MathContext mathContext) {
        return divideBy(Short.valueOf(divisor), mathContext);
    }

    public final IFunction<Float, Float> divideBy(int divisor, MathContext mathContext) {
        return divideBy(Integer.valueOf(divisor), mathContext);
    }

    public final IFunction<Float, Float> divideBy(long divisor, MathContext mathContext) {
    ...
    public final IFunction<Float, Float> divideBy(double divisor, MathContext mathContext) {
    ...
    public final IFunction<Float, Float> divideBy(byte divisor, RoundingMode roundingMode) {
        return divideBy(Byte.valueOf(divisor), roundingMode);
    }

    public final IFunction<Float, Float> divideBy(short divisor, RoundingMode roundingMode) {
        return divideBy(Short.valueOf(divisor), roundingMode);
    }

    public final IFunction<Float, Float> divideBy(int divisor, RoundingMode roundingMode) {
        return divideBy(Integer.valueOf(divisor), roundingMode);
    }

    public final IFunction<Float, Float> divideBy(long divisor, RoundingMode roundingMode) {
    ...
    public final IFunction<Float, Float> divideBy(double divisor, RoundingMode roundingMode) {
    ...
    public final IFunction<Float, Float> multiplyBy(byte multiplicand) {
        return multiplyBy(Byte.valueOf(multiplicand));
    }

    public final IFunction<Float, Float> multiplyBy(short multiplicand) {
        return multiplyBy(Short.valueOf(multiplicand));
    }

    public final IFunction<Float, Float> multiplyBy(int multiplicand) {
        return multiplyBy(Integer.valueOf(multiplicand));
    }

    public final IFunction<Float, Float> multiplyBy(long multiplicand) {
    ...
    public final IFunction<Float, Float> multiplyBy(double multiplicand) {
    ...
    public final IFunction<Float, Float> multiplyBy(byte multiplicand, MathContext mathContext) {
        return multiplyBy(Byte.valueOf(multiplicand), mathContext);
    }

    public final IFunction<Float, Float> multiplyBy(short multiplicand, MathContext mathContext) {
        return multiplyBy(Short.valueOf(multiplicand), mathContext);
    }

    public final IFunction<Float, Float> multiplyBy(int multiplicand, MathContext mathContext) {
        return multiplyBy(Integer.valueOf(multiplicand), mathContext);
    }

    public final IFunction<Float, Float> multiplyBy(long multiplicand, MathContext mathContext) {
    ...
    public final IFunction<Float, Float> multiplyBy(double multiplicand, MathContext mathContext) {
    ...
    public final IFunction<Float, Float> multiplyBy(byte multiplicand, RoundingMode roundingMode) {
        return multiplyBy(Byte.valueOf(multiplicand), roundingMode);
    }

    public final IFunction<Float, Float> multiplyBy(short multiplicand, RoundingMode roundingMode) {
        return multiplyBy(Short.valueOf(multiplicand), roundingMode);
    }

    public final IFunction<Float, Float> multiplyBy(int multiplicand, RoundingMode roundingMode) {
        return multiplyBy(Integer.valueOf(multiplicand), roundingMode);
    }

    public final IFunction<Float, Float> multiplyBy(long multiplicand, RoundingMode roundingMode) {
    ...
    public final IFunction<Float, Float> multiplyBy(double multiplicand, RoundingMode roundingMode) {
