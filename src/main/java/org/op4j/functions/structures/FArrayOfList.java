 ...
 * 
 */
public final class FArrayOfList<T> extends FArray<List<T>> {
    ...
    protected FArrayOfList(final Type<T> type) {
    ...
    public static final class FlattenLists<T> extends AbstractNotNullFunction<List<T>[],T[]> {

        private final Type<T> type; 

        public FlattenLists(final Type<T> type) {
            super();
